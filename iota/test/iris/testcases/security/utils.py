...
def GetDelphiSessionSummaryMetrics(node_name):
    ...
    "num_tcp_half_open_sessions": 0,
    "num_other_active_sessions": 0,
    "num_tcp_session_limit_drops": 0,
    "num_udp_session_limit_drops": 0,
    "num_icmp_session_limit_drops": 0,
    "num_other_session_limit_drops": 0,
    "num_dsc_session_limit_drops": 0
    }
    }
    '''
