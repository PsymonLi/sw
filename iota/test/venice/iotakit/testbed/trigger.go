...
// CopyToNode copies a file to node
func (tb *TestBed) CopyToNode(nodeName string, files []string, destDir string) error {
	// copy message
	copyMsg := iota.EntityCopyMsg{
		Direction:   iota.CopyDirection_DIR_IN,
		NodeName:    nodeName,
...
// CopyFromNode copies a file from node
func (tb *TestBed) CopyFromNode(nodeName string, files []string, destDir string) error {
	// copy message
	copyMsg := iota.EntityCopyMsg{
		Direction:   iota.CopyDirection_DIR_OUT,
		NodeName:    nodeName,
