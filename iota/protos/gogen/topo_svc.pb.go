...
type NodeRestartMethod int32

const (
	NodeRestartMethod_RESTART_METHOD_AUTO    NodeRestartMethod = 0
	NodeRestartMethod_RESTART_METHOD_APC     NodeRestartMethod = 1
	NodeRestartMethod_RESTART_METHOD_IPMI    NodeRestartMethod = 2
	NodeRestartMethod_RESTART_METHOD_REBOOT  NodeRestartMethod = 3
	NodeRestartMethod_RESTART_METHOD_REDFISH NodeRestartMethod = 4
)

var NodeRestartMethod_name = map[int32]string{
	0: "RESTART_METHOD_AUTO",
	1: "RESTART_METHOD_APC",
	2: "RESTART_METHOD_IPMI",
	3: "RESTART_METHOD_REBOOT",
	4: "RESTART_METHOD_REDFISH",
}
var NodeRestartMethod_value = map[string]int32{
...
func (x NodeRestartMethod) String() string {
	return proto.EnumName(NodeRestartMethod_name, int32(x))
}
func (NodeRestartMethod) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{1} }

type NaplesOperationMode int32

const (
	// Naples in regular mode ( 2 host interfaces)
	NaplesOperationMode_NAPLES_MODE_CLASSIC NaplesOperationMode = 0
	// Naples in bitw mode (no hostintf)
	NaplesOperationMode_NAPLES_MODE_BITW NaplesOperationMode = 1
)

var NaplesOperationMode_name = map[int32]string{
	0: "NAPLES_MODE_CLASSIC",
	1: "NAPLES_MODE_BITW",
}
var NaplesOperationMode_value = map[string]int32{
	"NAPLES_MODE_CLASSIC": 0,
	"NAPLES_MODE_BITW":    1,
}

func (x NaplesOperationMode) String() string {
	return proto.EnumName(NaplesOperationMode_name, int32(x))
}
func (NaplesOperationMode) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{2} }
...
const (
	...
	PersonalityType_PERSONALITY_K8S_MASTER          PersonalityType = 18
	PersonalityType_PERSONALITY_NAPLES_BOND         PersonalityType = 19
)
...
var PersonalityType_name = map[int32]string{
	...
	18: "PERSONALITY_K8S_MASTER",
	19: "PERSONALITY_NAPLES_BOND",
}
...
func (PersonalityType) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{3} }
...
func (EntityType) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{4} }

type InterfaceType int32

const (
	InterfaceType_INTERFACE_TYPE_NONE      InterfaceType = 0
	InterfaceType_INTERFACE_TYPE_NATIVE    InterfaceType = 1
	InterfaceType_INTERFACE_TYPE_VSS       InterfaceType = 2
	InterfaceType_INTERFACE_TYPE_SRIOV     InterfaceType = 3
	InterfaceType_INTERFACE_TYPE_DVS       InterfaceType = 4
	InterfaceType_INTERFACE_TYPE_DVS_PVLAN InterfaceType = 5
	InterfaceType_INTERFACE_TYPE_BOND      InterfaceType = 6
	InterfaceType_INTERFACE_TYPE_MGMT      InterfaceType = 7
)

var InterfaceType_name = map[int32]string{
	0: "INTERFACE_TYPE_NONE",
	1: "INTERFACE_TYPE_NATIVE",
	2: "INTERFACE_TYPE_VSS",
	3: "INTERFACE_TYPE_SRIOV",
	4: "INTERFACE_TYPE_DVS",
	5: "INTERFACE_TYPE_DVS_PVLAN",
	6: "INTERFACE_TYPE_BOND",
	7: "INTERFACE_TYPE_MGMT",
}
...
func (InterfaceType) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{5} }
...
func (WorkloadType) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{6} }
...
func (TriggerOp) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{7} }
...
func (TriggerMode) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{8} }
...
func (CommandMode) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{9} }
...
func (WorkloadMoveType) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{10} }
...
func (NetworkType) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{11} }
...
const (
	...
	SwitchOp_CREATE_PORT_CHANNEL SwitchOp = 11
	SwitchOp_DELETE_PORT_CHANNEL SwitchOp = 12
	SwitchOp_LLDP_INFO_GET       SwitchOp = 13
)
...
var SwitchOp_name = map[int32]string{
	...
	11: "CREATE_PORT_CHANNEL",
	12: "DELETE_PORT_CHANNEL",
	13: "LLDP_INFO_GET",
}
...
func (SwitchOp) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{12} }
...
const (
	...
	TestBedNodeType_TESTBED_NODE_TYPE_K8S_MASTER  TestBedNodeType = 7
)
...
var TestBedNodeType_name = map[int32]string{
	...
	7: "TESTBED_NODE_TYPE_K8S_MASTER",
}
...
func (TestBedNodeType) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{13} }
...
func (TestBedNodeOs) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{14} }
...
func (CopyDirection) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{15} }
...
func (NodeHealth_HealthCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorTopoSvc, []int{36, 0}
}
...
const (
	...
	DataSwitch_Speed_50G  DataSwitch_Speed = 1
	DataSwitch_Speed_10G  DataSwitch_Speed = 2
	DataSwitch_Speed_auto DataSwitch_Speed = 3
)
...
func (DataSwitch_Speed) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{45, 0} }
...
func (License_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{46, 0} }
...
type ReloadMsg struct {
	...
	RestartMethod NodeRestartMethod `protobuf:"varint,3,opt,name=restart_method,json=restartMethod,proto3,enum=iotamodel.NodeRestartMethod" json:"restart_method,omitempty"`
	MethodArgs    string            `protobuf:"bytes,4,opt,name=method_args,json=methodArgs,proto3" json:"method_args,omitempty"`
	UseNcsi       bool              `protobuf:"varint,5,opt,name=use_ncsi,json=useNcsi,proto3" json:"use_ncsi,omitempty"`
	SkipRestore   bool              `protobuf:"varint,6,opt,name=skip_restore,json=skipRestore,proto3" json:"skip_restore,omitempty"`
	// If request is to power-cycle and not wait for host to come online
	SkipAgentInit bool `protobuf:"varint,7,opt,name=skip_agent_init,json=skipAgentInit,proto3" json:"skip_agent_init,omitempty"`
}
...
func (m *ReloadMsg) GetRestartMethod() NodeRestartMethod {
	if m != nil {
		return m.RestartMethod
	}
	return NodeRestartMethod_RESTART_METHOD_AUTO
}

func (m *ReloadMsg) GetMethodArgs() string {
	if m != nil {
		return m.MethodArgs
	}
	return ""
...
func (m *ReloadMsg) GetSkipAgentInit() bool {
	if m != nil {
		return m.SkipAgentInit
	}
	return false
}
...
func (*DatacenterConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{4} }

func (m *DatacenterConfig) GetEsxConfigs() []*VmwareESXConfig {
	if m != nil {
		return m.EsxConfigs
	}
	return nil
...
func (m *DatacenterConfig) GetDcName() string {
	if m != nil {
		return m.DcName
	}
	return ""
...
func (m *DatacenterConfig) GetClusterName() string {
	if m != nil {
...
func (m *DatacenterConfig) GetDistributedSwitch() string {
	if m != nil {
...
func (m *DatacenterConfig) GetPvlanStart() uint32 {
	if m != nil {
		return m.PvlanStart
	}
	return 0
...
func (m *DatacenterConfig) GetPvlanEnd() uint32 {
	if m != nil {
		return m.PvlanEnd
	}
	return 0
...
func (m *DatacenterConfig) GetEnableVmotionOverMgmt() bool {
	if m != nil {
...
type VcenterConfig struct {
	DcConfigs      []*DatacenterConfig `protobuf:"bytes,1,rep,name=dc_configs,json=dcConfigs" json:"dc_configs,omitempty"`
	WorkloadImages []string            `protobuf:"bytes,2,rep,name=workload_images,json=workloadImages" json:"workload_images,omitempty"`
}
...
func (*VcenterConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{5} }

func (m *VcenterConfig) GetDcConfigs() []*DatacenterConfig {
	if m != nil {
		return m.DcConfigs
	}
	return nil
...
type BondConfig struct {
	BondInterfaceName string `protobuf:"bytes,1,opt,name=bond_interface_name,json=bondInterfaceName,proto3" json:"bond_interface_name,omitempty"`
	// Teaming Mode
	TeamingMode string `protobuf:"bytes,2,opt,name=teaming_mode,json=teamingMode,proto3" json:"teaming_mode,omitempty"`
	// Load Balancing Algorithm
	LoadBalancingAlgorithm string `protobuf:"bytes,3,opt,name=load_balancing_algorithm,json=loadBalancingAlgorithm,proto3" json:"load_balancing_algorithm,omitempty"`
	// vlan (subinterface)
	Vlans []string `protobuf:"bytes,4,rep,name=vlans" json:"vlans,omitempty"`
	// hint, if there are more than 1 naples in system
	NicHints []string `protobuf:"bytes,5,rep,name=nic_hints,json=nicHints" json:"nic_hints,omitempty"`
}

func (m *BondConfig) Reset()                    { *m = BondConfig{} }
func (m *BondConfig) String() string            { return proto.CompactTextString(m) }
func (*BondConfig) ProtoMessage()               {}
func (*BondConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{6} }

func (m *BondConfig) GetBondInterfaceName() string {
	if m != nil {
		return m.BondInterfaceName
	}
	return ""
}

func (m *BondConfig) GetTeamingMode() string {
	if m != nil {
		return m.TeamingMode
	}
	return ""
}

func (m *BondConfig) GetLoadBalancingAlgorithm() string {
	if m != nil {
		return m.LoadBalancingAlgorithm
	}
	return ""
}

func (m *BondConfig) GetVlans() []string {
	if m != nil {
		return m.Vlans
	}
	return nil
...
func (m *BondConfig) GetNicHints() []string {
	if m != nil {
		return m.NicHints
	}
	return nil
...
type BondConfigs struct {
	Configs []*BondConfig `protobuf:"bytes,1,rep,name=configs" json:"configs,omitempty"`
}

func (m *BondConfigs) Reset()                    { *m = BondConfigs{} }
func (m *BondConfigs) String() string            { return proto.CompactTextString(m) }
func (*BondConfigs) ProtoMessage()               {}
func (*BondConfigs) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{7} }

func (m *BondConfigs) GetConfigs() []*BondConfig {
	if m != nil {
		return m.Configs
	}
	return nil
...
func (*NaplesSimInfo) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{8} }
...
type K8SMasterConfig struct {
	// k8s master IP - not used for master node
	K8SMasterIp string `protobuf:"bytes,1,opt,name=k8s_master_ip,json=k8sMasterIp,proto3" json:"k8s_master_ip,omitempty"`
	// k8s master token
	K8SMasterToken string `protobuf:"bytes,2,opt,name=k8s_master_token,json=k8sMasterToken,proto3" json:"k8s_master_token,omitempty"`
}

func (m *K8SMasterConfig) Reset()                    { *m = K8SMasterConfig{} }
func (m *K8SMasterConfig) String() string            { return proto.CompactTextString(m) }
func (*K8SMasterConfig) ProtoMessage()               {}
func (*K8SMasterConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{9} }

func (m *K8SMasterConfig) GetK8SMasterIp() string {
	if m != nil {
		return m.K8SMasterIp
	}
	return ""
}

func (m *K8SMasterConfig) GetK8SMasterToken() string {
	if m != nil {
		return m.K8SMasterToken
	}
	return ""
}
...
type Node struct {
	...
	NodeStatus *IotaAPIResponse `protobuf:"bytes,13,opt,name=node_status,json=nodeStatus" json:"node_status,omitempty"`
	...
	// Types that are valid to be assigned to OverlayConfigs:
	//	*Node_BondConfigs
	OverlayConfigs isNode_OverlayConfigs `protobuf_oneof:"overlay_configs"`
	// node install information
	InstallInfo *InstallInfo `protobuf:"bytes,21,opt,name=install_info,json=installInfo" json:"install_info,omitempty"`
}

func (m *Node) Reset()                    { *m = Node{} }
func (m *Node) String() string            { return proto.CompactTextString(m) }
func (*Node) ProtoMessage()               {}
func (*Node) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{10} }
...
type isNode_OverlayConfigs interface {
	isNode_OverlayConfigs()
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type Node_KubeConfig struct {
	KubeConfig *K8SMasterConfig `protobuf:"bytes,12,opt,name=kube_config,json=kubeConfig,oneof"`
}
type Node_BondConfigs struct {
	BondConfigs *BondConfigs `protobuf:"bytes,20,opt,name=bond_configs,json=bondConfigs,oneof"`
}
...
func (*Node_KubeConfig) isNode_NodeInfo()             {}
func (*Node_BondConfigs) isNode_OverlayConfigs()      {}
...
func (m *Node) GetOverlayConfigs() isNode_OverlayConfigs {
	if m != nil {
		return m.OverlayConfigs
	}
	return nil
}
...
func (m *Node) GetKubeConfig() *K8SMasterConfig {
	if x, ok := m.GetNodeInfo().(*Node_KubeConfig); ok {
		return x.KubeConfig
	}
	return nil
}
...
func (m *Node) GetBondConfigs() *BondConfigs {
	if x, ok := m.GetOverlayConfigs().(*Node_BondConfigs); ok {
		return x.BondConfigs
	}
	return nil
}

func (m *Node) GetInstallInfo() *InstallInfo {
	if m != nil {
		return m.InstallInfo
	}
	return nil
}
...
func _Node_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Node_KubeConfig:
		_ = b.EncodeVarint(12<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.KubeConfig); err != nil {
			return err
		}
	case nil:
	default:
	...
	// overlay_configs
	switch x := m.OverlayConfigs.(type) {
	case *Node_BondConfigs:
		_ = b.EncodeVarint(20<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.BondConfigs); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("Node.OverlayConfigs has unexpected type %T", x)
	}
	return nil
}
...
func _Node_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 11: // node_info.vcenter_config
		...
		return true, err
	case 12: // node_info.kube_config
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(K8SMasterConfig)
		err := b.DecodeMessage(msg)
		m.NodeInfo = &Node_KubeConfig{msg}
		return true, err
	case 20: // overlay_configs.bond_configs
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(BondConfigs)
		err := b.DecodeMessage(msg)
		m.OverlayConfigs = &Node_BondConfigs{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*ApcInfo) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{11} }
...
func (*NaplesMultiSimConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{12} }
...
func (*NaplesControlSimConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{13} }
...
type NaplesConfig struct {
	...
	HostIntfs []*Interfaces `protobuf:"bytes,5,rep,name=host_intfs,json=hostIntfs" json:"host_intfs,omitempty"`
	...
	NaplesMode NaplesOperationMode `protobuf:"varint,14,opt,name=naples_mode,json=naplesMode,proto3,enum=iotamodel.NaplesOperationMode" json:"naples_mode,omitempty"`
	// k8s master info
	KubeInfo *K8SMasterConfig `protobuf:"bytes,15,opt,name=kubeInfo" json:"kubeInfo,omitempty"`
	// if not internal mgmt
	NoMgmt bool `protobuf:"varint,16,opt,name=no_mgmt,json=noMgmt,proto3" json:"no_mgmt,omitempty"`
	// set to true if workloads should not share switch
	NoSwitchShare bool `protobuf:"varint,17,opt,name=no_switch_share,json=noSwitchShare,proto3" json:"no_switch_share,omitempty"`
}
...
func (*NaplesConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{14} }
...
func (m *NaplesConfig) GetHostIntfs() []*Interfaces {
	if m != nil {
		return m.HostIntfs
	}
	return nil
...
func (m *NaplesConfig) GetNaplesMode() NaplesOperationMode {
	if m != nil {
		return m.NaplesMode
	}
	return NaplesOperationMode_NAPLES_MODE_CLASSIC
}

func (m *NaplesConfig) GetKubeInfo() *K8SMasterConfig {
	if m != nil {
		return m.KubeInfo
	}
	return nil
...
func (m *NaplesConfig) GetNoMgmt() bool {
	if m != nil {
		return m.NoMgmt
	}
	return false
...
func (m *NaplesConfig) GetNoSwitchShare() bool {
	if m != nil {
		return m.NoSwitchShare
	}
	return false
}
...
func (*NaplesConfigs) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{15} }
...
func (*ThirdPartyNicConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{16} }
...
func (*MellanoxConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{17} }
...
func (*BroadcomConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{18} }
...
func (*IntelConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{19} }
...
func (*VenicePeer) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{20} }
...
type VeniceClusterInfo struct {
	// license for cluster
	Licenses []string `protobuf:"bytes,1,rep,name=licenses" json:"licenses,omitempty"`
}

func (m *VeniceClusterInfo) Reset()                    { *m = VeniceClusterInfo{} }
func (m *VeniceClusterInfo) String() string            { return proto.CompactTextString(m) }
func (*VeniceClusterInfo) ProtoMessage()               {}
func (*VeniceClusterInfo) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{21} }

func (m *VeniceClusterInfo) GetLicenses() []string {
	if m != nil {
		return m.Licenses
	}
	return nil
...
type VeniceConfig struct {
	...
	ClusterInfo *VeniceClusterInfo `protobuf:"bytes,4,opt,name=cluster_info,json=clusterInfo" json:"cluster_info,omitempty"`
}
...
func (*VeniceConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{22} }
...
func (m *VeniceConfig) GetClusterInfo() *VeniceClusterInfo {
	if m != nil {
...
func (*WorkloadMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{23} }
...
func (*DvsInfo) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{24} }
...
func (*ExposedPorts) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{25} }
...
type Interfaces struct {
	Type       InterfaceType `protobuf:"varint,1,opt,name=type,proto3,enum=iotamodel.InterfaceType" json:"type,omitempty"`
...
func (*Interfaces) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{26} }

func (m *Interfaces) GetType() InterfaceType {
	if m != nil {
		return m.Type
	}
...
func (m *Interfaces) GetParent() string {
	if m != nil {
		return m.Parent
	}
	return ""
...
type Interface struct {
	...
	InterfaceIndex uint32   `protobuf:"varint,16,opt,name=interface_index,json=interfaceIndex,proto3" json:"interface_index,omitempty"`
	// device hosting parent interface
	DeviceName string `protobuf:"bytes,17,opt,name=device_name,json=deviceName,proto3" json:"device_name,omitempty"`
}

func (m *Interface) Reset()                    { *m = Interface{} }
func (m *Interface) String() string            { return proto.CompactTextString(m) }
func (*Interface) ProtoMessage()               {}
func (*Interface) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{27} }
...
func (m *Interface) GetInterfaceIndex() uint32 {
	if m != nil {
...
func (m *Interface) GetDeviceName() string {
	if m != nil {
		return m.DeviceName
	}
	return ""
...
func (*Workload) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{28} }
...
func (*TriggerMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{29} }
...
func (*Command) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{30} }
...
type WorkloadMove struct {
	...
	// src node name
	SrcDcName string `protobuf:"bytes,2,opt,name=src_dc_name,json=srcDcName,proto3" json:"src_dc_name,omitempty"`
	// dst node name
	DstDcName string `protobuf:"bytes,3,opt,name=dst_dc_name,json=dstDcName,proto3" json:"dst_dc_name,omitempty"`
	// src node name
	SrcNodeName string `protobuf:"bytes,4,opt,name=src_node_name,json=srcNodeName,proto3" json:"src_node_name,omitempty"`
	// dst node name
	DstNodeName string `protobuf:"bytes,5,opt,name=dst_node_name,json=dstNodeName,proto3" json:"dst_node_name,omitempty"`
	// entity name to run command on
	...
	VlanOverride uint32 `protobuf:"varint,7,opt,name=vlan_override,json=vlanOverride,proto3" json:"vlan_override,omitempty"`
	// current vlan if we want to override after move
	CurrentVlan uint32 `protobuf:"varint,8,opt,name=current_vlan,json=currentVlan,proto3" json:"current_vlan,omitempty"`
	// Switch name for vlan override
	SwitchName string `protobuf:"bytes,9,opt,name=switch_name,json=switchName,proto3" json:"switch_name,omitempty"`
	// Abort Workload Move after time in sec (if non-zero)
	AbortTime uint32 `protobuf:"varint,10,opt,name=abort_time,json=abortTime,proto3" json:"abort_time,omitempty"`
	// workload move response
	ApiResponse *IotaAPIResponse `protobuf:"bytes,11,opt,name=api_response,json=apiResponse" json:"api_response,omitempty"`
}
...
func (*WorkloadMove) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{31} }
...
func (m *WorkloadMove) GetSrcDcName() string {
	if m != nil {
		return m.SrcDcName
	}
	return ""
...
func (m *WorkloadMove) GetDstDcName() string {
	if m != nil {
		return m.DstDcName
	}
	return ""
...
type WorkloadMoveMsg struct {
	...
	NumParallelMoves uint32 `protobuf:"varint,4,opt,name=num_parallel_moves,json=numParallelMoves,proto3" json:"num_parallel_moves,omitempty"`
}
...
func (*WorkloadMoveMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{32} }
...
func (m *WorkloadMoveMsg) GetNumParallelMoves() uint32 {
	if m != nil {
		return m.NumParallelMoves
	}
	return 0
}
...
func (*Network) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{33} }
...
type NetworksMsg struct {
	...
	Switch  string     `protobuf:"bytes,5,opt,name=switch,proto3" json:"switch,omitempty"`
	// Orchestrator node
	OrchestratorNode string `protobuf:"bytes,6,opt,name=orchestrator_node,json=orchestratorNode,proto3" json:"orchestrator_node,omitempty"`
}
...
func (*NetworksMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{34} }
...
func (m *NetworksMsg) GetDc() string {
	if m != nil {
		return m.Dc
	}
	return ""
...
func (m *NetworksMsg) GetCluster() string {
	if m != nil {
		return m.Cluster
	}
	return ""
...
func (*ClusterHealthMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{35} }
...
func (*NodeHealth) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{36} }
...
func (*NetworkQosClass) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{37} }
...
func (*NetworkPolicyQos) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{38} }
...
func (*NetworkDscpClass) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{39} }
...
func (*NetworkDscpPolicy) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{40} }
...
func (*NetworkQueueClass) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{41} }
...
func (*NetworkQueuePolicy) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{42} }
...
type PortChannelConfig struct {
	// switch ip
	SwitchIp string `protobuf:"bytes,1,opt,name=switch_ip,json=switchIp,proto3" json:"switch_ip,omitempty"`
	// Name of the port-channel
	ChNumber string `protobuf:"bytes,2,opt,name=ch_number,json=chNumber,proto3" json:"ch_number,omitempty"`
	// member ports
	Ports []string `protobuf:"bytes,3,rep,name=ports" json:"ports,omitempty"`
}

func (m *PortChannelConfig) Reset()                    { *m = PortChannelConfig{} }
func (m *PortChannelConfig) String() string            { return proto.CompactTextString(m) }
func (*PortChannelConfig) ProtoMessage()               {}
func (*PortChannelConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{43} }

func (m *PortChannelConfig) GetSwitchIp() string {
	if m != nil {
		return m.SwitchIp
	}
	return ""
...
func (m *PortChannelConfig) GetChNumber() string {
	if m != nil {
		return m.ChNumber
	}
	return ""
...
func (m *PortChannelConfig) GetPorts() []string {
	if m != nil {
		return m.Ports
	}
	return nil
...
type PortChannelConfigs struct {
	Configs []*PortChannelConfig `protobuf:"bytes,1,rep,name=configs" json:"configs,omitempty"`
}

func (m *PortChannelConfigs) Reset()                    { *m = PortChannelConfigs{} }
func (m *PortChannelConfigs) String() string            { return proto.CompactTextString(m) }
func (*PortChannelConfigs) ProtoMessage()               {}
func (*PortChannelConfigs) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{44} }

func (m *PortChannelConfigs) GetConfigs() []*PortChannelConfig {
	if m != nil {
		return m.Configs
	}
	return nil
...
func (*DataSwitch) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{45} }
...
func (*License) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{46} }
...
type TestBedMsg struct {
	...
	AllocatedVlans []uint32 `protobuf:"varint,2,rep,packed,name=allocated_vlans,json=allocatedVlans" json:"allocated_vlans,omitempty"`
	...
	Nodes []*TestBedNode `protobuf:"bytes,4,rep,name=nodes" json:"nodes,omitempty"`
	// Node username
	Username string `protobuf:"bytes,5,opt,name=username,proto3" json:"username,omitempty"`
	// Node password
	Password string `protobuf:"bytes,6,opt,name=password,proto3" json:"password,omitempty"`
	// Testbed ID
	TestbedId uint32 `protobuf:"varint,7,opt,name=testbed_id,json=testbedId,proto3" json:"testbed_id,omitempty"`
	// DataSwitch
	DataSwitches []*DataSwitch `protobuf:"bytes,8,rep,name=data_switches,json=dataSwitches" json:"data_switches,omitempty"`
	// Reboot Nodes
	RebootNodes bool `protobuf:"varint,9,opt,name=reboot_nodes,json=rebootNodes,proto3" json:"reboot_nodes,omitempty"`
	// global licenses
	Licenses []*License `protobuf:"bytes,10,rep,name=licenses" json:"licenses,omitempty"`
	// Testbed Jobc/testbed json file
	TestbedJsonFile string `protobuf:"bytes,11,opt,name=testbed_json_file,json=testbedJsonFile,proto3" json:"testbed_json_file,omitempty"`
	// reset nodes, don't install new image
	OnlyReset bool `protobuf:"varint,12,opt,name=only_reset,json=onlyReset,proto3" json:"only_reset,omitempty"`
	// Testbed InstanceID
	TestbedInstId string `protobuf:"bytes,13,opt,name=testbed_inst_id,json=testbedInstId,proto3" json:"testbed_inst_id,omitempty"`
}
...
func (*TestBedMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{47} }
...
func (m *TestBedMsg) GetOnlyReset() bool {
	if m != nil {
		return m.OnlyReset
	}
	return false
...
func (m *TestBedMsg) GetTestbedInstId() string {
	if m != nil {
		return m.TestbedInstId
	}
	return ""
}

type InstallInfo struct {
	Node *TestBedNode `protobuf:"bytes,1,opt,name=node" json:"node,omitempty"`
	// reset nodes, don't install new image
	OnlyReset       bool     `protobuf:"varint,2,opt,name=only_reset,json=onlyReset,proto3" json:"only_reset,omitempty"`
	Images          []string `protobuf:"bytes,3,rep,name=images" json:"images,omitempty"`
	TestbedJsonFile string   `protobuf:"bytes,4,opt,name=testbed_json_file,json=testbedJsonFile,proto3" json:"testbed_json_file,omitempty"`
}
...
func (*InstallInfo) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{48} }

func (m *InstallInfo) GetNode() *TestBedNode {
	if m != nil {
		return m.Node
	}
	return nil
...
func (m *InstallInfo) GetOnlyReset() bool {
	if m != nil {
		return m.OnlyReset
	}
	return false
...
func (m *InstallInfo) GetImages() []string {
	if m != nil {
		return m.Images
	}
	return nil
...
func (m *InstallInfo) GetTestbedJsonFile() string {
	if m != nil {
		return m.TestbedJsonFile
	}
	return ""
...
func (*TestNodesMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{49} }
...
func (*VlanConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{50} }
...
func (*SwitchFlapInfo) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{51} }
...
func (*PortPauseConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{52} }
...
func (*PortPfcConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{53} }
...
func (*PortQosConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{54} }
...
func (*PortQueuingConfig) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{55} }
...
type PortLLDPInfo struct {
	MgmtAddr string `protobuf:"bytes,1,opt,name=mgmt_addr,json=mgmtAddr,proto3" json:"mgmt_addr,omitempty"`
	PortDesc string `protobuf:"bytes,2,opt,name=port_desc,json=portDesc,proto3" json:"port_desc,omitempty"`
	SysDesc  string `protobuf:"bytes,3,opt,name=sys_desc,json=sysDesc,proto3" json:"sys_desc,omitempty"`
...
func (m *PortLLDPInfo) Reset()                    { *m = PortLLDPInfo{} }
func (m *PortLLDPInfo) String() string            { return proto.CompactTextString(m) }
func (*PortLLDPInfo) ProtoMessage()               {}
func (*PortLLDPInfo) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{56} }

func (m *PortLLDPInfo) GetMgmtAddr() string {
	if m != nil {
		return m.MgmtAddr
	}
	return ""
...
func (m *PortLLDPInfo) GetPortDesc() string {
	if m != nil {
		return m.PortDesc
	}
	return ""
...
func (m *PortLLDPInfo) GetSysDesc() string {
	if m != nil {
		return m.SysDesc
	}
	return ""
...
func (m *PortLLDPInfo) GetSysName() string {
	if m != nil {
		return m.SysName
	}
	return ""
...
func (m *PortLLDPInfo) GetPort() string {
	if m != nil {
		return m.Port
	}
	return ""
...
func (m *PortLLDPInfo) GetSwitch() string {
	if m != nil {
		return m.Switch
	}
	return ""
...
type LLDPInfo struct {
	PortsLldpInfo []*PortLLDPInfo `protobuf:"bytes,1,rep,name=ports_lldp_info,json=portsLldpInfo" json:"ports_lldp_info,omitempty"`
}

func (m *LLDPInfo) Reset()                    { *m = LLDPInfo{} }
func (m *LLDPInfo) String() string            { return proto.CompactTextString(m) }
func (*LLDPInfo) ProtoMessage()               {}
func (*LLDPInfo) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{57} }

func (m *LLDPInfo) GetPortsLldpInfo() []*PortLLDPInfo {
	if m != nil {
		return m.PortsLldpInfo
	}
	return nil
}
...
type SwitchMsg struct {
	...
	PortChannelConfigs *PortChannelConfigs         `protobuf:"bytes,10,opt,name=port_channel_configs,json=portChannelConfigs" json:"port_channel_configs,omitempty"`
	LldpInfo           *LLDPInfo                   `protobuf:"bytes,11,opt,name=lldp_info,json=lldpInfo" json:"lldp_info,omitempty"`
}
...
func (*SwitchMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{58} }
...
func (m *SwitchMsg) GetPortChannelConfigs() *PortChannelConfigs {
	if m != nil {
		return m.PortChannelConfigs
	}
	return nil
}

func (m *SwitchMsg) GetLldpInfo() *LLDPInfo {
	if m != nil {
		return m.LldpInfo
	}
	return nil
...
type TestBedNode struct {
	...
	NoMgmt     bool   `protobuf:"varint,26,opt,name=no_mgmt,json=noMgmt,proto3" json:"no_mgmt,omitempty"`
	CimcNcsiIp string `protobuf:"bytes,27,opt,name=cimc_ncsi_ip,json=cimcNcsiIp,proto3" json:"cimc_ncsi_ip,omitempty"`
	// auto discover on install
	AutoDiscoverOnInstall bool `protobuf:"varint,28,opt,name=auto_discover_on_install,json=autoDiscoverOnInstall,proto3" json:"auto_discover_on_install,omitempty"`
	// warmd instance name
	InstanceName string `protobuf:"bytes,29,opt,name=instance_name,json=instanceName,proto3" json:"instance_name,omitempty"`
}
...
func (*TestBedNode) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{59} }
...
func (*EntityCopyMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{60} }
...
func (*DownloadAssetsMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{61} }
...
func (*PrepareWorkspaceMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{62} }
...
type UnsetBreakoutMsg struct {
	// API Response
	ApiResponse *IotaAPIResponse `protobuf:"bytes,1,opt,name=api_response,json=apiResponse" json:"api_response,omitempty"`
	// DataSwitch
	DataSwitches []*DataSwitch `protobuf:"bytes,2,rep,name=data_switches,json=dataSwitches" json:"data_switches,omitempty"`
}

func (m *UnsetBreakoutMsg) Reset()                    { *m = UnsetBreakoutMsg{} }
func (m *UnsetBreakoutMsg) String() string            { return proto.CompactTextString(m) }
func (*UnsetBreakoutMsg) ProtoMessage()               {}
func (*UnsetBreakoutMsg) Descriptor() ([]byte, []int) { return fileDescriptorTopoSvc, []int{63} }

func (m *UnsetBreakoutMsg) GetApiResponse() *IotaAPIResponse {
	if m != nil {
		return m.ApiResponse
	}
	return nil
...
func (m *UnsetBreakoutMsg) GetDataSwitches() []*DataSwitch {
	if m != nil {
		return m.DataSwitches
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DatacenterConfig)(nil), "iotamodel.DatacenterConfig")
	proto.RegisterType((*VcenterConfig)(nil), "iotamodel.VcenterConfig")
	proto.RegisterType((*BondConfig)(nil), "iotamodel.BondConfig")
	proto.RegisterType((*BondConfigs)(nil), "iotamodel.BondConfigs")
	proto.RegisterType((*NaplesSimInfo)(nil), "iotamodel.NaplesSimInfo")
	proto.RegisterType((*K8SMasterConfig)(nil), "iotamodel.K8sMasterConfig")
	...
	proto.RegisterType((*VeniceClusterInfo)(nil), "iotamodel.VeniceClusterInfo")
	...
	proto.RegisterType((*Interfaces)(nil), "iotamodel.Interfaces")
	...
	proto.RegisterType((*PortChannelConfig)(nil), "iotamodel.PortChannelConfig")
	proto.RegisterType((*PortChannelConfigs)(nil), "iotamodel.PortChannelConfigs")
	...
	proto.RegisterType((*InstallInfo)(nil), "iotamodel.InstallInfo")
	...
	proto.RegisterType((*PortLLDPInfo)(nil), "iotamodel.PortLLDPInfo")
	proto.RegisterType((*LLDPInfo)(nil), "iotamodel.LLDPInfo")
	...
	proto.RegisterType((*UnsetBreakoutMsg)(nil), "iotamodel.UnsetBreakoutMsg")
	proto.RegisterEnum("iotamodel.Op", Op_name, Op_value)
	proto.RegisterEnum("iotamodel.NodeRestartMethod", NodeRestartMethod_name, NodeRestartMethod_value)
	proto.RegisterEnum("iotamodel.NaplesOperationMode", NaplesOperationMode_name, NaplesOperationMode_value)
...
type TopologyApiClient interface {
	...
	// GetNodes returns the topology information of all the nodes.
	ReInitNodes(ctx context.Context, in *NodeMsg, opts ...grpc.CallOption) (*NodeMsg, error)
	...
	UnsetBreakoutInterfaces(ctx context.Context, in *UnsetBreakoutMsg, opts ...grpc.CallOption) (*UnsetBreakoutMsg, error)
}
...
func (c *topologyApiClient) ReInitNodes(ctx context.Context, in *NodeMsg, opts ...grpc.CallOption) (*NodeMsg, error) {
	out := new(NodeMsg)
	err := grpc.Invoke(ctx, "/iotamodel.TopologyApi/ReInitNodes", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topologyApiClient) UnsetBreakoutInterfaces(ctx context.Context, in *UnsetBreakoutMsg, opts ...grpc.CallOption) (*UnsetBreakoutMsg, error) {
	out := new(UnsetBreakoutMsg)
	err := grpc.Invoke(ctx, "/iotamodel.TopologyApi/UnsetBreakoutInterfaces", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TopologyApiServer interface {
	...
	// GetNodes returns the topology information of all the nodes.
	ReInitNodes(context.Context, *NodeMsg) (*NodeMsg, error)
	// SaveNodes saves node and download state from host to runner/localhost
	...
	// remove breakout interfaces from switch
	UnsetBreakoutInterfaces(context.Context, *UnsetBreakoutMsg) (*UnsetBreakoutMsg, error)
}
...
func _TopologyApi_ReInitNodes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TopologyApiServer).ReInitNodes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iotamodel.TopologyApi/ReInitNodes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopologyApiServer).ReInitNodes(ctx, req.(*NodeMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TopologyApi_UnsetBreakoutInterfaces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnsetBreakoutMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TopologyApiServer).UnsetBreakoutInterfaces(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iotamodel.TopologyApi/UnsetBreakoutInterfaces",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopologyApiServer).UnsetBreakoutInterfaces(ctx, req.(*UnsetBreakoutMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _TopologyApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReInitNodes",
			Handler:    _TopologyApi_ReInitNodes_Handler,
		},
		{
		...
		{
			MethodName: "UnsetBreakoutInterfaces",
			Handler:    _TopologyApi_UnsetBreakoutInterfaces_Handler,
		},
	},
...
func (m *ReloadMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RestartMethod != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.RestartMethod))
	}
	if len(m.MethodArgs) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.MethodArgs)))
		i += copy(dAtA[i:], m.MethodArgs)
	}
	if m.UseNcsi {
		dAtA[i] = 0x28
		i++
...
func (m *DatacenterConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DatacenterConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *VcenterConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DcConfigs) > 0 {
		for _, msg := range m.DcConfigs {
			dAtA[i] = 0xa
			i++
			i = encodeVarintTopoSvc(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *BondConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BondConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.BondInterfaceName) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.BondInterfaceName)))
		i += copy(dAtA[i:], m.BondInterfaceName)
	}
	if len(m.TeamingMode) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.TeamingMode)))
		i += copy(dAtA[i:], m.TeamingMode)
	}
	if len(m.LoadBalancingAlgorithm) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.LoadBalancingAlgorithm)))
		i += copy(dAtA[i:], m.LoadBalancingAlgorithm)
	}
	if len(m.Vlans) > 0 {
		for _, s := range m.Vlans {
			dAtA[i] = 0x22
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *BondConfigs) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BondConfigs) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *K8SMasterConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *K8SMasterConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.K8SMasterIp) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.K8SMasterIp)))
		i += copy(dAtA[i:], m.K8SMasterIp)
	}
	if len(m.K8SMasterToken) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.K8SMasterToken)))
		i += copy(dAtA[i:], m.K8SMasterToken)
	}
	return i, nil
}
...
func (m *Node) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OverlayConfigs != nil {
		nn9, err := m.OverlayConfigs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn9
	}
	if m.InstallInfo != nil {
		dAtA[i] = 0xaa
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.InstallInfo.Size()))
		n10, err := m.InstallInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *Node_NaplesConfigs) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NaplesConfigs != nil {
		...
		n11, err := m.NaplesConfigs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *Node_VeniceConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VeniceConfig != nil {
		...
		n12, err := m.VeniceConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *Node_ThirdPartyNicConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ThirdPartyNicConfig != nil {
		...
		n13, err := m.ThirdPartyNicConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *Node_NaplesMultiSimConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NaplesMultiSimConfig != nil {
		...
		n14, err := m.NaplesMultiSimConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *Node_NaplesControlSimConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NaplesControlSimConfig != nil {
		...
		n15, err := m.NaplesControlSimConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *Node_VcenterConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VcenterConfig != nil {
		...
		n16, err := m.VcenterConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *Node_KubeConfig) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.KubeConfig != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.KubeConfig.Size()))
		n17, err := m.KubeConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *Node_BondConfigs) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.BondConfigs != nil {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.BondConfigs.Size()))
		n18, err := m.BondConfigs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *NaplesConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NaplesMode != 0 {
		dAtA[i] = 0x70
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.NaplesMode))
	}
	if m.KubeInfo != nil {
		dAtA[i] = 0x7a
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.KubeInfo.Size()))
		n19, err := m.KubeInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *VeniceClusterInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *VeniceClusterInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *VeniceConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClusterInfo != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.ClusterInfo.Size()))
		n20, err := m.ClusterInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *Interface) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Dvs != nil {
		...
		n22, err := m.Dvs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
	...
	if m.InterfaceIndex != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.InterfaceIndex))
	}
	if len(m.DeviceName) > 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.DeviceName)))
...
func (m *Workload) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.WorkloadStatus != nil {
		...
		n23, err := m.WorkloadStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *WorkloadMove) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SrcDcName) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.SrcDcName)))
		i += copy(dAtA[i:], m.SrcDcName)
	}
	if len(m.DstDcName) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.DstDcName)))
		i += copy(dAtA[i:], m.DstDcName)
	}
...
func (m *WorkloadMoveMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NumParallelMoves != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.NumParallelMoves))
	}
	return i, nil
}
...
func (m *NetworksMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Dc) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.Dc)))
		i += copy(dAtA[i:], m.Dc)
	}
	if len(m.Cluster) > 0 {
		dAtA[i] = 0x22
...
func (m *PortChannelConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PortChannelConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.SwitchIp) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.SwitchIp)))
		i += copy(dAtA[i:], m.SwitchIp)
	}
	if len(m.ChNumber) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.ChNumber)))
		i += copy(dAtA[i:], m.ChNumber)
	}
	if len(m.Ports) > 0 {
...
func (m *PortChannelConfigs) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PortChannelConfigs) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *DataSwitch) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Qos != nil {
		...
		n29, err := m.Qos.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
	...
	if m.Dscp != nil {
		...
		n30, err := m.Dscp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.Queue != nil {
		...
		n31, err := m.Queue.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *TestBedMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.AllocatedVlans) > 0 {
		dAtA34 := make([]byte, len(m.AllocatedVlans)*10)
		var j33 int
		for _, num := range m.AllocatedVlans {
			for num >= 1<<7 {
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(j33))
	...
	if len(m.TestbedInstId) > 0 {
		dAtA[i] = 0x6a
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.TestbedInstId)))
		i += copy(dAtA[i:], m.TestbedInstId)
	}
	return i, nil
}

func (m *InstallInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *InstallInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Node != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.Node.Size()))
...
func (m *TestNodesMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ApiResponse != nil {
		...
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.ApiResponse.Size()))
		n36, err := m.ApiResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *PortLLDPInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PortLLDPInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.MgmtAddr) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.MgmtAddr)))
		i += copy(dAtA[i:], m.MgmtAddr)
	}
	if len(m.PortDesc) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.PortDesc)))
		i += copy(dAtA[i:], m.PortDesc)
	}
	if len(m.SysDesc) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.SysDesc)))
		i += copy(dAtA[i:], m.SysDesc)
	}
	if len(m.SysName) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(len(m.SysName)))
...
func (m *LLDPInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *LLDPInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.PortsLldpInfo) > 0 {
		for _, msg := range m.PortsLldpInfo {
			dAtA[i] = 0xa
			i++
			i = encodeVarintTopoSvc(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *SwitchMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ApiResponse != nil {
		...
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.ApiResponse.Size()))
		n37, err := m.ApiResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
	...
	if m.OpInfo != nil {
		nn38, err := m.OpInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn38
	...
	if m.SwitchInfo != nil {
		nn39, err := m.SwitchInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn39
	...
	if m.PauseInfo != nil {
		nn40, err := m.PauseInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn40
	...
	if m.PfcInfo != nil {
		nn41, err := m.PfcInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn41
	...
	if m.PortQosInfo != nil {
		nn42, err := m.PortQosInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn42
	...
	if m.PortQueuingInfo != nil {
		nn43, err := m.PortQueuingInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn43
	}
	if m.PortChannelConfigs != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.PortChannelConfigs.Size()))
		n44, err := m.PortChannelConfigs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.LldpInfo != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.LldpInfo.Size()))
		n45, err := m.LldpInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *SwitchMsg_FlapInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FlapInfo != nil {
		...
		n46, err := m.FlapInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *SwitchMsg_VlanConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VlanConfig != nil {
		...
		n47, err := m.VlanConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *SwitchMsg_PortPause) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PortPause != nil {
		...
		n48, err := m.PortPause.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *SwitchMsg_PortPfc) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PortPfc != nil {
		...
		n49, err := m.PortPfc.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *SwitchMsg_PortQos) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PortQos != nil {
		...
		n50, err := m.PortQos.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *SwitchMsg_PortQueuing) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PortQueuing != nil {
		...
		n51, err := m.PortQueuing.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *TestBedNode) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SwitchPortIds) > 0 {
		dAtA53 := make([]byte, len(m.SwitchPortIds)*10)
		var j52 int
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(j52))
	...
	if m.ApcInfo != nil {
		...
		n54, err := m.ApcInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
func (m *EntityCopyMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ApiResponse != nil {
		...
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.ApiResponse.Size()))
		n55, err := m.ApiResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n55
...
func (m *DownloadAssetsMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ApiResponse != nil {
		...
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.ApiResponse.Size()))
		n56, err := m.ApiResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n56
...
func (m *PrepareWorkspaceMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ApiResponse != nil {
		...
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.ApiResponse.Size()))
		n57, err := m.ApiResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n57
...
func (m *UnsetBreakoutMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UnsetBreakoutMsg) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.ApiResponse != nil {
		...
		i++
		i = encodeVarintTopoSvc(dAtA, i, uint64(m.ApiResponse.Size()))
		n58, err := m.ApiResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n58
...
func (m *ReloadMsg) Size() (n int) {
	...
	if m.RestartMethod != 0 {
		n += 1 + sovTopoSvc(uint64(m.RestartMethod))
	}
	l = len(m.MethodArgs)
	if l > 0 {
		n += 1 + l + sovTopoSvc(uint64(l))
...
func (m *DatacenterConfig) Size() (n int) {
	var l int
	_ = l
	if len(m.EsxConfigs) > 0 {
...
func (m *BondConfig) Size() (n int) {
	var l int
	_ = l
	l = len(m.BondInterfaceName)
	if l > 0 {
		n += 1 + l + sovTopoSvc(uint64(l))
	}
	l = len(m.TeamingMode)
	...
	l = len(m.LoadBalancingAlgorithm)
	if l > 0 {
		n += 1 + l + sovTopoSvc(uint64(l))
	}
	if len(m.Vlans) > 0 {
...
func (m *K8SMasterConfig) Size() (n int) {
	var l int
	_ = l
	l = len(m.K8SMasterIp)
	if l > 0 {
...
func (m *Node) Size() (n int) {
	...
	if m.OverlayConfigs != nil {
		n += m.OverlayConfigs.Size()
	}
	if m.InstallInfo != nil {
		l = m.InstallInfo.Size()
		n += 2 + l + sovTopoSvc(uint64(l))
	}
	return n
}
...
func (m *Node_KubeConfig) Size() (n int) {
	var l int
	_ = l
	if m.KubeConfig != nil {
		l = m.KubeConfig.Size()
...
func (m *Node_BondConfigs) Size() (n int) {
	var l int
	_ = l
	if m.BondConfigs != nil {
		l = m.BondConfigs.Size()
		n += 2 + l + sovTopoSvc(uint64(l))
	}
	return n
}
...
func (m *NaplesConfig) Size() (n int) {
	...
	if m.NaplesMode != 0 {
		n += 1 + sovTopoSvc(uint64(m.NaplesMode))
	}
	if m.KubeInfo != nil {
		l = m.KubeInfo.Size()
		n += 1 + l + sovTopoSvc(uint64(l))
...
func (m *VeniceClusterInfo) Size() (n int) {
	var l int
	_ = l
	if len(m.Licenses) > 0 {
		for _, s := range m.Licenses {
...
func (m *Interface) Size() (n int) {
	...
	if m.InterfaceIndex != 0 {
		n += 2 + sovTopoSvc(uint64(m.InterfaceIndex))
	}
	l = len(m.DeviceName)
	if l > 0 {
		n += 2 + l + sovTopoSvc(uint64(l))
...
func (m *WorkloadMoveMsg) Size() (n int) {
	...
	if m.NumParallelMoves != 0 {
		n += 1 + sovTopoSvc(uint64(m.NumParallelMoves))
	}
	return n
}
...
func (m *PortChannelConfig) Size() (n int) {
	var l int
	_ = l
	l = len(m.SwitchIp)
	if l > 0 {
...
func (m *PortChannelConfigs) Size() (n int) {
	var l int
	_ = l
	if len(m.Configs) > 0 {
		for _, e := range m.Configs {
...
func (m *PortLLDPInfo) Size() (n int) {
	var l int
	_ = l
	l = len(m.MgmtAddr)
	if l > 0 {
...
func (m *LLDPInfo) Size() (n int) {
	var l int
	_ = l
	if len(m.PortsLldpInfo) > 0 {
		for _, e := range m.PortsLldpInfo {
			l = e.Size()
			n += 1 + l + sovTopoSvc(uint64(l))
		}
	}
...
func (m *UnsetBreakoutMsg) Size() (n int) {
	var l int
	_ = l
	if m.ApiResponse != nil {
		l = m.ApiResponse.Size()
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RestartMethod |= (NodeRestartMethod(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MethodArgs", wireType)
			}
			...
			m.MethodArgs = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipAgentInit", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *DatacenterConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DatacenterConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DatacenterConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VcenterConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DcConfigs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DcConfigs = append(m.DcConfigs, &DatacenterConfig{})
			if err := m.DcConfigs[len(m.DcConfigs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *BondConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BondConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BondConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BondInterfaceName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BondInterfaceName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TeamingMode", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TeamingMode = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LoadBalancingAlgorithm", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LoadBalancingAlgorithm = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.Vlans = append(m.Vlans, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NicHints", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NicHints = append(m.NicHints, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTopoSvc(dAtA[iNdEx:])
...
func (m *BondConfigs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BondConfigs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BondConfigs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Configs = append(m.Configs, &BondConfig{})
...
func (m *K8SMasterConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: K8sMasterConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: K8sMasterConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field K8SMasterIp", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.K8SMasterIp = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field K8SMasterToken", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.K8SMasterToken = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTopoSvc(dAtA[iNdEx:])
...
func (m *Node) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BondConfigs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OverlayConfigs = &Node_BondConfigs{v}
			iNdEx = postIndex
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InstallInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.InstallInfo == nil {
				m.InstallInfo = &InstallInfo{}
			}
			if err := m.InstallInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *NaplesConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.HostIntfs = append(m.HostIntfs, &Interfaces{})
			if err := m.HostIntfs[len(m.HostIntfs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NaplesMode", wireType)
			}
			m.NaplesMode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NaplesMode |= (NaplesOperationMode(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KubeInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.KubeInfo == nil {
				m.KubeInfo = &K8SMasterConfig{}
			}
			if err := m.KubeInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 16:
		...
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NoSwitchShare", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *VeniceClusterInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VeniceClusterInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VeniceClusterInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VeniceConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.ClusterInfo == nil {
				m.ClusterInfo = &VeniceClusterInfo{}
			}
	...
	for iNdEx < l {
		...
		case 16:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InterfaceIndex |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *WorkloadMove) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SrcDcName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SrcDcName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DstDcName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DstDcName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *WorkloadMoveMsg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumParallelMoves", wireType)
			}
			m.NumParallelMoves = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTopoSvc
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumParallelMoves |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *NetworksMsg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Dc = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *PortChannelConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PortChannelConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PortChannelConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChNumber", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ChNumber = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *PortChannelConfigs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PortChannelConfigs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PortChannelConfigs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Configs = append(m.Configs, &PortChannelConfig{})
			if err := m.Configs[len(m.Configs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *TestBedMsg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnlyReset", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OnlyReset = bool(v != 0)
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TestbedInstId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TestbedInstId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTopoSvc(dAtA[iNdEx:])
...
func (m *InstallInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: InstallInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InstallInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PortLLDPInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PortLLDPInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PortLLDPInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PortDesc", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PortDesc = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SysDesc", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SysDesc = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *LLDPInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LLDPInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LLDPInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PortsLldpInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PortsLldpInfo = append(m.PortsLldpInfo, &PortLLDPInfo{})
			if err := m.PortsLldpInfo[len(m.PortsLldpInfo)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *SwitchMsg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PortChannelConfigs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PortChannelConfigs == nil {
				m.PortChannelConfigs = &PortChannelConfigs{}
			}
			if err := m.PortChannelConfigs.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
			...
			if err := m.LldpInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *UnsetBreakoutMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnsetBreakoutMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnsetBreakoutMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorTopoSvc = []byte{
	...
	,
}
