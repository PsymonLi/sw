...
type IotaAgentApiClient interface {
	...
	// RetrieveNode builds Node msg for agent <-> server to sync
	ReInitNode(ctx context.Context, in *Node, opts ...grpc.CallOption) (*Node, error)
...
func (c *iotaAgentApiClient) ReInitNode(ctx context.Context, in *Node, opts ...grpc.CallOption) (*Node, error) {
	out := new(Node)
	err := grpc.Invoke(ctx, "/iotamodel.IotaAgentApi/ReInitNode", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IotaAgentApiServer interface {
	...
	// RetrieveNode builds Node msg for agent <-> server to sync
	ReInitNode(context.Context, *Node) (*Node, error)
	// DeleteNode, remove the personaltiy set
...
func _IotaAgentApi_ReInitNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Node)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IotaAgentApiServer).ReInitNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iotamodel.IotaAgentApi/ReInitNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IotaAgentApiServer).ReInitNode(ctx, req.(*Node))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _IotaAgentApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReInitNode",
			Handler:    _IotaAgentApi_ReInitNode_Handler,
		},
		{
...
var fileDescriptorAgent = []byte{
	...
	,
}
