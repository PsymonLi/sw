...
func (a adapterStagingV1) AutoAddBuffer(oldctx oldcontext.Context, t *staging.Buffer, options ...grpc.CallOption) (*staging.Buffer, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			srvCl, ok := cl.(staging.StagingV1Client)
			if !ok {
			...
			return srvCl.AutoAddBuffer(inctx, in)
		}
		return a.service.AutoAddBuffer(inctx, in)
	}
...
func (a adapterStagingV1) AutoDeleteBuffer(oldctx oldcontext.Context, t *staging.Buffer, options ...grpc.CallOption) (*staging.Buffer, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoDeleteBuffer(inctx, in)
		}
		return a.service.AutoDeleteBuffer(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterStagingV1) AutoGetBuffer(oldctx oldcontext.Context, t *staging.Buffer, options ...grpc.CallOption) (*staging.Buffer, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoGetBuffer(inctx, in)
		}
		return a.service.AutoGetBuffer(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterStagingV1) AutoLabelBuffer(oldctx oldcontext.Context, t *api.Label, options ...grpc.CallOption) (*staging.Buffer, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoLabelBuffer(inctx, in)
		}
		return a.service.AutoLabelBuffer(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterStagingV1) AutoListBuffer(oldctx oldcontext.Context, t *api.ListWatchOptions, options ...grpc.CallOption) (*staging.BufferList, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoListBuffer(inctx, in)
		}
		return a.service.AutoListBuffer(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterStagingV1) AutoUpdateBuffer(oldctx oldcontext.Context, t *staging.Buffer, options ...grpc.CallOption) (*staging.Buffer, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoUpdateBuffer(inctx, in)
		}
		return a.service.AutoUpdateBuffer(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterStagingV1) Bulkedit(oldctx oldcontext.Context, t *staging.BulkEditAction, options ...grpc.CallOption) (*staging.BulkEditAction, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.Bulkedit(inctx, in)
		}
		return a.service.Bulkedit(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterStagingV1) Clear(oldctx oldcontext.Context, t *staging.ClearAction, options ...grpc.CallOption) (*staging.ClearAction, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.Clear(inctx, in)
		}
		return a.service.Clear(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterStagingV1) Commit(oldctx oldcontext.Context, t *staging.CommitAction, options ...grpc.CallOption) (*staging.CommitAction, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.Commit(inctx, in)
		}
		return a.service.Commit(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
