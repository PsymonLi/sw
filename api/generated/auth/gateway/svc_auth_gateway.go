...
func (a adapterAuthV1) AutoAddAuthenticationPolicy(oldctx oldcontext.Context, t *auth.AuthenticationPolicy, options ...grpc.CallOption) (*auth.AuthenticationPolicy, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoAddAuthenticationPolicy(inctx, in)
		}
		return a.service.AutoAddAuthenticationPolicy(inctx, in)
	}
...
func (a adapterAuthV1) AutoAddRole(oldctx oldcontext.Context, t *auth.Role, options ...grpc.CallOption) (*auth.Role, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoAddRole(inctx, in)
		}
		return a.service.AutoAddRole(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoAddRoleBinding(oldctx oldcontext.Context, t *auth.RoleBinding, options ...grpc.CallOption) (*auth.RoleBinding, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoAddRoleBinding(inctx, in)
		}
		return a.service.AutoAddRoleBinding(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoAddUser(oldctx oldcontext.Context, t *auth.User, options ...grpc.CallOption) (*auth.User, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoAddUser(inctx, in)
		}
		return a.service.AutoAddUser(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoAddUserPreference(oldctx oldcontext.Context, t *auth.UserPreference, options ...grpc.CallOption) (*auth.UserPreference, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoAddUserPreference(inctx, in)
		}
		return a.service.AutoAddUserPreference(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoDeleteAuthenticationPolicy(oldctx oldcontext.Context, t *auth.AuthenticationPolicy, options ...grpc.CallOption) (*auth.AuthenticationPolicy, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoDeleteAuthenticationPolicy(inctx, in)
		}
		return a.service.AutoDeleteAuthenticationPolicy(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoDeleteRole(oldctx oldcontext.Context, t *auth.Role, options ...grpc.CallOption) (*auth.Role, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoDeleteRole(inctx, in)
		}
		return a.service.AutoDeleteRole(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoDeleteRoleBinding(oldctx oldcontext.Context, t *auth.RoleBinding, options ...grpc.CallOption) (*auth.RoleBinding, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoDeleteRoleBinding(inctx, in)
		}
		return a.service.AutoDeleteRoleBinding(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoDeleteUser(oldctx oldcontext.Context, t *auth.User, options ...grpc.CallOption) (*auth.User, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoDeleteUser(inctx, in)
		}
		return a.service.AutoDeleteUser(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoDeleteUserPreference(oldctx oldcontext.Context, t *auth.UserPreference, options ...grpc.CallOption) (*auth.UserPreference, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoDeleteUserPreference(inctx, in)
		}
		return a.service.AutoDeleteUserPreference(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoGetAuthenticationPolicy(oldctx oldcontext.Context, t *auth.AuthenticationPolicy, options ...grpc.CallOption) (*auth.AuthenticationPolicy, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoGetAuthenticationPolicy(inctx, in)
		}
		return a.service.AutoGetAuthenticationPolicy(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoGetRole(oldctx oldcontext.Context, t *auth.Role, options ...grpc.CallOption) (*auth.Role, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoGetRole(inctx, in)
		}
		return a.service.AutoGetRole(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoGetRoleBinding(oldctx oldcontext.Context, t *auth.RoleBinding, options ...grpc.CallOption) (*auth.RoleBinding, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoGetRoleBinding(inctx, in)
		}
		return a.service.AutoGetRoleBinding(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoGetUser(oldctx oldcontext.Context, t *auth.User, options ...grpc.CallOption) (*auth.User, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoGetUser(inctx, in)
		}
		return a.service.AutoGetUser(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoGetUserPreference(oldctx oldcontext.Context, t *auth.UserPreference, options ...grpc.CallOption) (*auth.UserPreference, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoGetUserPreference(inctx, in)
		}
		return a.service.AutoGetUserPreference(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoLabelAuthenticationPolicy(oldctx oldcontext.Context, t *api.Label, options ...grpc.CallOption) (*auth.AuthenticationPolicy, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoLabelAuthenticationPolicy(inctx, in)
		}
		return a.service.AutoLabelAuthenticationPolicy(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoLabelRole(oldctx oldcontext.Context, t *api.Label, options ...grpc.CallOption) (*auth.Role, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoLabelRole(inctx, in)
		}
		return a.service.AutoLabelRole(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoLabelRoleBinding(oldctx oldcontext.Context, t *api.Label, options ...grpc.CallOption) (*auth.RoleBinding, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoLabelRoleBinding(inctx, in)
		}
		return a.service.AutoLabelRoleBinding(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoLabelUser(oldctx oldcontext.Context, t *api.Label, options ...grpc.CallOption) (*auth.User, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoLabelUser(inctx, in)
		}
		return a.service.AutoLabelUser(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoLabelUserPreference(oldctx oldcontext.Context, t *api.Label, options ...grpc.CallOption) (*auth.UserPreference, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoLabelUserPreference(inctx, in)
		}
		return a.service.AutoLabelUserPreference(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoListAuthenticationPolicy(oldctx oldcontext.Context, t *api.ListWatchOptions, options ...grpc.CallOption) (*auth.AuthenticationPolicyList, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoListAuthenticationPolicy(inctx, in)
		}
		return a.service.AutoListAuthenticationPolicy(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoListRole(oldctx oldcontext.Context, t *api.ListWatchOptions, options ...grpc.CallOption) (*auth.RoleList, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoListRole(inctx, in)
		}
		return a.service.AutoListRole(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoListRoleBinding(oldctx oldcontext.Context, t *api.ListWatchOptions, options ...grpc.CallOption) (*auth.RoleBindingList, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoListRoleBinding(inctx, in)
		}
		return a.service.AutoListRoleBinding(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoListUser(oldctx oldcontext.Context, t *api.ListWatchOptions, options ...grpc.CallOption) (*auth.UserList, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoListUser(inctx, in)
		}
		return a.service.AutoListUser(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoListUserPreference(oldctx oldcontext.Context, t *api.ListWatchOptions, options ...grpc.CallOption) (*auth.UserPreferenceList, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoListUserPreference(inctx, in)
		}
		return a.service.AutoListUserPreference(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoUpdateAuthenticationPolicy(oldctx oldcontext.Context, t *auth.AuthenticationPolicy, options ...grpc.CallOption) (*auth.AuthenticationPolicy, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoUpdateAuthenticationPolicy(inctx, in)
		}
		return a.service.AutoUpdateAuthenticationPolicy(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoUpdateRole(oldctx oldcontext.Context, t *auth.Role, options ...grpc.CallOption) (*auth.Role, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoUpdateRole(inctx, in)
		}
		return a.service.AutoUpdateRole(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoUpdateRoleBinding(oldctx oldcontext.Context, t *auth.RoleBinding, options ...grpc.CallOption) (*auth.RoleBinding, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoUpdateRoleBinding(inctx, in)
		}
		return a.service.AutoUpdateRoleBinding(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoUpdateUser(oldctx oldcontext.Context, t *auth.User, options ...grpc.CallOption) (*auth.User, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoUpdateUser(inctx, in)
		}
		return a.service.AutoUpdateUser(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) AutoUpdateUserPreference(oldctx oldcontext.Context, t *auth.UserPreference, options ...grpc.CallOption) (*auth.UserPreference, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoUpdateUserPreference(inctx, in)
		}
		return a.service.AutoUpdateUserPreference(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) IsAuthorized(oldctx oldcontext.Context, t *auth.SubjectAccessReviewRequest, options ...grpc.CallOption) (*auth.User, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.IsAuthorized(inctx, in)
		}
		return a.service.IsAuthorized(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) LdapBindCheck(oldctx oldcontext.Context, t *auth.AuthenticationPolicy, options ...grpc.CallOption) (*auth.AuthenticationPolicy, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.LdapBindCheck(inctx, in)
		}
		return a.service.LdapBindCheck(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) LdapConnectionCheck(oldctx oldcontext.Context, t *auth.AuthenticationPolicy, options ...grpc.CallOption) (*auth.AuthenticationPolicy, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.LdapConnectionCheck(inctx, in)
		}
		return a.service.LdapConnectionCheck(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) PasswordChange(oldctx oldcontext.Context, t *auth.PasswordChangeRequest, options ...grpc.CallOption) (*auth.User, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.PasswordChange(inctx, in)
		}
		return a.service.PasswordChange(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) PasswordReset(oldctx oldcontext.Context, t *auth.PasswordResetRequest, options ...grpc.CallOption) (*auth.User, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.PasswordReset(inctx, in)
		}
		return a.service.PasswordReset(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterAuthV1) TokenSecretGenerate(oldctx oldcontext.Context, t *auth.TokenSecretRequest, options ...grpc.CallOption) (*auth.AuthenticationPolicy, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.TokenSecretGenerate(inctx, in)
		}
		return a.service.TokenSecretGenerate(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
