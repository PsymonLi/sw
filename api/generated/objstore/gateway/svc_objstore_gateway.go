...
func (a adapterObjstoreV1) AutoAddBucket(oldctx oldcontext.Context, t *objstore.Bucket, options ...grpc.CallOption) (*objstore.Bucket, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			srvCl, ok := cl.(objstore.ObjstoreV1Client)
			if !ok {
			...
			return srvCl.AutoAddBucket(inctx, in)
		}
		return a.service.AutoAddBucket(inctx, in)
	}
...
func (a adapterObjstoreV1) AutoAddObject(oldctx oldcontext.Context, t *objstore.Object, options ...grpc.CallOption) (*objstore.Object, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoAddObject(inctx, in)
		}
		return a.service.AutoAddObject(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoDeleteBucket(oldctx oldcontext.Context, t *objstore.Bucket, options ...grpc.CallOption) (*objstore.Bucket, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoDeleteBucket(inctx, in)
		}
		return a.service.AutoDeleteBucket(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoDeleteObject(oldctx oldcontext.Context, t *objstore.Object, options ...grpc.CallOption) (*objstore.Object, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoDeleteObject(inctx, in)
		}
		return a.service.AutoDeleteObject(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoGetBucket(oldctx oldcontext.Context, t *objstore.Bucket, options ...grpc.CallOption) (*objstore.Bucket, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoGetBucket(inctx, in)
		}
		return a.service.AutoGetBucket(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoGetObject(oldctx oldcontext.Context, t *objstore.Object, options ...grpc.CallOption) (*objstore.Object, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoGetObject(inctx, in)
		}
		return a.service.AutoGetObject(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoLabelBucket(oldctx oldcontext.Context, t *api.Label, options ...grpc.CallOption) (*objstore.Bucket, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoLabelBucket(inctx, in)
		}
		return a.service.AutoLabelBucket(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoLabelObject(oldctx oldcontext.Context, t *api.Label, options ...grpc.CallOption) (*objstore.Object, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoLabelObject(inctx, in)
		}
		return a.service.AutoLabelObject(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoListBucket(oldctx oldcontext.Context, t *api.ListWatchOptions, options ...grpc.CallOption) (*objstore.BucketList, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoListBucket(inctx, in)
		}
		return a.service.AutoListBucket(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoListObject(oldctx oldcontext.Context, t *api.ListWatchOptions, options ...grpc.CallOption) (*objstore.ObjectList, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoListObject(inctx, in)
		}
		return a.service.AutoListObject(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoUpdateBucket(oldctx oldcontext.Context, t *objstore.Bucket, options ...grpc.CallOption) (*objstore.Bucket, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoUpdateBucket(inctx, in)
		}
		return a.service.AutoUpdateBucket(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
...
func (a adapterObjstoreV1) AutoUpdateObject(oldctx oldcontext.Context, t *objstore.Object, options ...grpc.CallOption) (*objstore.Object, error) {
	...
	fn := func(inctx context.Context, i interface{}) (interface{}, error) {
		...
		if ok {
			...
			return srvCl.AutoUpdateObject(inctx, in)
		}
		return a.service.AutoUpdateObject(inctx, in)
	}
	ret, err := a.gw.HandleRequest(ctx, t, prof, fn)
	if ret == nil {
		return nil, err
