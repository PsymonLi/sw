...
var typesMapSmartnic = map[string]*api.Struct{
	...
	"cluster.DistributedServiceCard": &api.Struct{
		...
		CLITags: map[string]api.CLIInfo{
			...
			"is-connected-to-psm":   api.CLIInfo{Path: "Status.IsConnectedToPSM", Skip: false, Insert: "", Help: ""},
	...
	"cluster.DistributedServiceCardSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"PolicerAttachTenant": api.Field{Name: "PolicerAttachTenant", CLITag: api.CLIInfo{ID: "policer-attach-tenant", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "policer-attach-tenant", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
