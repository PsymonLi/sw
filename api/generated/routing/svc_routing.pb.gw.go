...
func request_RoutingV1_ListRoutes_0(ctx context.Context, marshaler runtime.Marshaler, client RoutingV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	protoReq := &RouteFilter{}
	var smetadata runtime.ServerMetadata
	...
	msg, err := client.ListRoutes(ctx, protoReq, grpc.Header(&smetadata.HeaderMD), grpc.Trailer(&smetadata.TrailerMD))
	return msg, smetadata, err

}

var (
	filter_RoutingV1_ListRoutes_1 = &utilities.DoubleArray{Encoding: map[string]int{"Instance": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_RoutingV1_ListRoutes_1(ctx context.Context, marshaler runtime.Marshaler, client RoutingV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	protoReq := &RouteFilter{}
	var smetadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(protoReq, req.URL.Query(), filter_RoutingV1_ListRoutes_1); err != nil {
		return nil, smetadata, grpc.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterRoutingV1HandlerWithClient(ctx context.Context, mux *runtime.ServeMux, client RoutingV1Client) error {
	...
	mux.Handle("POST", pattern_RoutingV1_ListRoutes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_RoutingV1_ListRoutes_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, outboundMarshaler, w, req, err)
			return
		...
		forward_RoutingV1_ListRoutes_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_RoutingV1_ListRoutes_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_RoutingV1_ListRoutes_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, outboundMarshaler, w, req, err)
			return
		...
		forward_RoutingV1_ListRoutes_1(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_RoutingV1_ListRoutes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{1, 0, 4, 1, 5, 0, 2, 1}, []string{"Instance", "routes"}, ""))

	pattern_RoutingV1_ListRoutes_1 = runtime.MustPattern(runtime.NewPattern(1, []int{1, 0, 4, 1, 5, 0, 2, 1}, []string{"Instance", "routes"}, ""))
)
...
var (
	...
	forward_RoutingV1_ListRoutes_0 = runtime.ForwardResponseMessage

	forward_RoutingV1_ListRoutes_1 = runtime.ForwardResponseMessage
)
