...
class IpsecEncryptSAObjectClient(base.ConfigClientBase):
    ...
    def AssociateObjects(self, node):
        EzAccessStoreClient[node].SetIpsecEncryptSA(self.Objects(node))
        ResmgrClient[node].CreateIpsecEncryptSAAllocator()
...
class IpsecDecryptSAObjectClient(base.ConfigClientBase):
    ...
    def AssociateObjects(self, node):
        EzAccessStoreClient[node].SetIpsecDecryptSA(self.Objects(node))
        ResmgrClient[node].CreateIpsecDecryptSAAllocator()
