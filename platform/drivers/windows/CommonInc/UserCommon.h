...
#define IOCTL_IONIC_SET_BUDGET			CTL_CODE(FILE_DEVICE_UNKNOWN, 0x10108, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
// Budget type
#define BUDGET_TYPE_RX			0x0001
#define BUDGET_TYPE_RX_MINI		0x0002
#define BUDGET_TYPE_TX			0x0003
