...
#define IOCTL_IONIC_SET_TX_BUDGET       CTL_CODE(FILE_DEVICE_UNKNOWN, 0x1010e, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IONIC_SET_RX_MINI_BUDGET  CTL_CODE(FILE_DEVICE_UNKNOWN, 0x1010f, METHOD_BUFFERED, FILE_ANY_ACCESS)
