...
#define ALL_CLOSE_PROCESSORS			(INVALID_PROCESSOR_INDEX)
#define ANY_PROCESSOR_INDEX				(INVALID_PROCESSOR_INDEX - 1)
#define ANY_PROCESSOR_CLOSE_INDEX		(INVALID_PROCESSOR_INDEX - 2)
#define NOT_PROCESSOR_INDEX				(INVALID_PROCESSOR_INDEX - 3)
#define NOT_PROCESSOR_CLOSE_INDEX		(INVALID_PROCESSOR_INDEX - 4)
#define MATCH_PROCESSOR_INDEX			(INVALID_PROCESSOR_INDEX - 5)
...
#define IONIC_DEFAULT_STATE						(IONIC_STATE_FLAG_TXRX_DIFF_CORE | IONIC_STATE_TX_INTERRUPT)
