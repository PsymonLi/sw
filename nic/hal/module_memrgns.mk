...
MODULE_DEPS   = ${TOPDIR}/nic/tools/hal/mem_parser.py \
		${TOPDIR}/nic/conf/${PIPELINE}/${ASIC}/8g/hbm_mem.json
MODULE_ARGS = ${TOPDIR}/nic/conf/${PIPELINE}/${ASIC}/8g/hbm_mem.json \
		${BLD_GEN_DIR}/platform/mem_regions.hpp \
		${PIPELINE}
else
MODULE_DEPS   = ${TOPDIR}/nic/tools/hal/mem_parser.py \
		${TOPDIR}/nic/conf/${PIPELINE}/${ASIC}/4g/hbm_mem.json
MODULE_ARGS = ${TOPDIR}/nic/conf/${PIPELINE}/${ASIC}/4g/hbm_mem.json \
		${BLD_GEN_DIR}/platform/mem_regions.hpp \
		${PIPELINE}
endif
