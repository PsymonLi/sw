...
{
    hal_ret_t ret = HAL_RET_OK;
    pd::pd_qos_swm_and_control_queue_init_args_t pd_qos_swm_and_control_args = {0};
    pd::pd_func_args_t pd_func_args = {0};
   ...
   // PD Call to init SWM/Control queue
    pd_qos_swm_and_control_args.swm_init = swm_init;
    pd_qos_swm_and_control_args.control_init = control_init;
    pd_func_args.pd_qos_swm_and_control_queue_init = &pd_qos_swm_and_control_args;
    ret = pd::hal_pd_call(pd::PD_FUNC_ID_QOS_SWM_AND_CONTROL_QUEUE_INIT, &pd_func_args);
    if (ret != HAL_RET_OK) {
...
{
    hal_ret_t ret = HAL_RET_OK;
    pd::pd_qos_swm_and_control_queue_deinit_args_t pd_qos_swm_and_control_args = {0};
    pd::pd_func_args_t pd_func_args = {0};
    ...
    pd_qos_swm_and_control_args.swm_deinit = swm_deinit;
    pd_qos_swm_and_control_args.control_deinit = control_deinit;
    pd_func_args.pd_qos_swm_and_control_queue_deinit = &pd_qos_swm_and_control_args;
    ret = pd::hal_pd_call(pd::PD_FUNC_ID_QOS_SWM_AND_CONTROL_QUEUE_DEINIT, &pd_func_args);
    if (ret != HAL_RET_OK) {
...
{
    hal_ret_t ret = HAL_RET_OK;
    pd::pd_qos_swm_and_control_add_del_mac_args_t pd_qos_swm_and_control_args = {0};
    pd::pd_func_args_t pd_func_args = {0};
    ...
    pd_qos_swm_and_control_args.uplink_port = uplink_port;
    pd_qos_swm_and_control_args.dmac = dmac;
    pd_qos_swm_and_control_args.add = add;
    pd_func_args.pd_qos_swm_and_control_add_del_mac = &pd_qos_swm_and_control_args;
    ret = pd::hal_pd_call(pd::PD_FUNC_ID_QOS_SWM_AND_CONTROL_ADD_DEL_MAC, &pd_func_args);
    if (ret != HAL_RET_OK) {
