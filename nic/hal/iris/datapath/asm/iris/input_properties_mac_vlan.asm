...
input_properties_mac_vlan_common:
    ...
    // clear mirror, return
    seq             c1, d.u.input_properties_mac_vlan_d.clear_ingresss_mirror, TRUE
    phvwr.c1.e      p.control_metadata_clear_ingresss_mirror, \
                        d.u.input_properties_mac_vlan_d.clear_ingresss_mirror
    // skip_flow_update, return
    seq             c2, d.u.input_properties_mac_vlan_d.skip_flow_update, TRUE
    phvwr.c2.e      p.control_metadata_skip_flow_update, \
                        d.u.input_properties_mac_vlan_d.skip_flow_update
    phvwr.!c2       p.flow_miss_metadata_tunnel_originate, \
                        d.u.input_properties_mac_vlan_d.tunnel_originate
    phvwr           p.control_metadata_ep_learn_en, \
                        d.u.input_properties_mac_vlan_d.ep_learn_en
    phvwr           p.control_metadata_clear_ingresss_mirror, \
                        d.u.input_properties_mac_vlan_d.clear_ingresss_mirror
    or              r1, k.capri_intrinsic_tm_span_session, \
                        d.u.input_properties_mac_vlan_d.ingress_mirror_session_id
    ...
    phvwr           p.capri_intrinsic_tm_replicate_ptr, \
                        d.u.input_properties_mac_vlan_d.flow_miss_idx
    phvwr           p.control_metadata_flow_miss_qos_class_id, \
                        d.u.input_properties_mac_vlan_d.flow_miss_qos_class_id

    or              r1, d.u.input_properties_mac_vlan_d.vrf, \
                        d.u.input_properties_mac_vlan_d.ipsg_enable, 17
    ...
    or              r1, 2, d.u.input_properties_mac_vlan_d.mdest_flow_miss_action, 3
    ...
    or              r1, d.u.input_properties_mac_vlan_d.tunnel_vnid, \
                        d.u.input_properties_mac_vlan_d.tunnel_rewrite_index, 24
    or              r1, r1, d.u.input_properties_mac_vlan_d.rewrite_index, 40
    ...
    phvwr           p.flow_lkp_metadata_lkp_dir, \
                        d.u.input_properties_mac_vlan_d.dir
    phvwr           p.l4_metadata_profile_idx, \
                        d.u.input_properties_mac_vlan_d.l4_profile_idx
    or.e            r1, 0x11, d.u.input_properties_mac_vlan_d.src_if_label, 1
