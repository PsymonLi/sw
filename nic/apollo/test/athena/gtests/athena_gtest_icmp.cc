...
/*
 * Host to Switch ICMP flow bad checksum : Packet to be sent
 */
static uint8_t g_snd_pkt_ipv4_icmp_bad_icmp_csum_h2s[] = {
    0x00, 0x00, 0xF1, 0xD0, 0xD1, 0xD0, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x01, 0x81, 0x00, 0x00, 0x04,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x50, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x01, 0xB6, 0xAB, 0x02, 0x00,
    0x00, 0x01, 0xC0, 0x00, 0x02, 0x01, 0x08, 0x00,
    0xC8, 0x93, 0x12, 0x34, 0x00, 0x00, 0x61, 0x62,
    0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A,
    0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72,
    0x73, 0x74, 0x75, 0x76, 0x77, 0x7A, 0x78, 0x79,
    0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68,
 ...
 * Switch to Host ICMP flow: Packet to be sent
 */
static uint8_t g_snd_pkt_ipv4_icmp_bad_icmp_csum_s2h[] = {
    0x00, 0x12, 0x34, 0x56, 0x78, 0x90, 0x00, 0xAA,
    0xBB, 0xCC, 0xDD, 0xEE, 0x08, 0x00, 0x45, 0x00,
    0x00, 0x74, 0x00, 0x00, 0x00, 0x00, 0x40, 0x11,
    0xA2, 0xA0, 0x64, 0x65, 0x66, 0x67, 0x0C, 0x0C,
...
static uint8_t g_rcv_pkt_ipv6_icmp_h2s[] = {
    ...
    0x40, 0x00, 0xff, 0x11, 0x71, 0x57, 0x04, 0x03,
    0x02, 0x01, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00,
...
#endif
/*
 * Host to Switch IPv6 ICMP BAD CSUM flow: Packet to be sent
 */
static uint8_t g_snd_pkt_ipv6_icmp_bad_icmp_csum_h2s[] = {
    0x00, 0x00, 0xF1, 0xD0, 0xD1, 0xD0, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x01, 0x81, 0x00, 0x00, 0x04,
    0x86, 0xDD, 0x60, 0x00, 0x00, 0x00, 0x00, 0x40,
    0x3A, 0x40, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x01, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x02, 0x01, 0x80, 0x00, 0x40, 0x17, 0x12, 0x34,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x61, 0x62,
    0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A,
    0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72,
    0x73, 0x74, 0x75, 0x76, 0x77, 0x7A, 0x78, 0x79,
...
/*
 * Switch to Host IPv6 ICMP BAD CSUM flow: Packet to be sent
 */
static uint8_t g_snd_pkt_ipv6_icmp_bad_icmp_csum_s2h[] = {
    0x00, 0x12, 0x34, 0x56, 0x78, 0x90, 0x00, 0xAA,
    0xBB, 0xCC, 0xDD, 0xEE, 0x08, 0x00, 0x45, 0x00,
    0x00, 0x8C, 0x00, 0x00, 0x00, 0x00, 0x40, 0x11,
    0xA2, 0x88, 0x64, 0x65, 0x66, 0x67, 0x0C, 0x0C,
    ...
    0x02, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x01, 0x80, 0x00, 0x40, 0x17, 0x12, 0x34,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x61, 0x62,
    0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A,
    0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72,
    0x73, 0x74, 0x75, 0x76, 0x77, 0x7A, 0x78, 0x79,
...
athena_gtest_test_flows_icmp(void)
{
    ...
    ret = send_packet("ICMP-IPv4: h2s bad csum pkt", g_snd_pkt_ipv4_icmp_bad_icmp_csum_h2s,
            sizeof(g_snd_pkt_ipv4_icmp_bad_icmp_csum_h2s), g_h_port,
			    NULL, 0,0);
    ...
    ret = send_packet("ICMP-IPv4: s2h bad csum pkt", g_snd_pkt_ipv4_icmp_bad_icmp_csum_s2h,
            sizeof(g_snd_pkt_ipv4_icmp_bad_icmp_csum_s2h), g_s_port,
            NULL,0,0);
    if (ret != SDK_RET_OK) {
        return ret;
    }
    ...
    ret = send_packet("ICMP-IPv6: h2s bad csum pkt", g_snd_pkt_ipv6_icmp_bad_icmp_csum_h2s,
            sizeof(g_snd_pkt_ipv6_icmp_bad_icmp_csum_h2s), g_h_port,
            NULL, 0,0);
    if (ret != SDK_RET_OK) {
        return ret;
    }
    ...
    ret = send_packet("ICMP-IPv6: s2h bad csum pkt", g_snd_pkt_ipv6_icmp_bad_icmp_csum_s2h,
            sizeof(g_snd_pkt_ipv6_icmp_bad_icmp_csum_s2h), g_s_port,
            NULL, 0, 0);
    if (ret != SDK_RET_OK) {
        return ret;
    }
