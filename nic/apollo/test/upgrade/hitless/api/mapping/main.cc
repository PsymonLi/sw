...
/// \brief Local mapping WF_U_1_N_1
/// \ref WF_U_1_N_1
TEST_F(mapping_upg_test, local_mapping_workflow_u1_neg_1) {
    ...
    // setup precursor again
    mapping_upg_setup();
    // setup feeder again for num of stashed objs
    feeder1.init(k_vpc_key, k_subnet_key, "10.0.0.2/8",
                 0x000000030b020a01, PDS_ENCAP_TYPE_VXLAN,
                 pdsobjkey2int(k_subnet_key) + 512,
                 int2pdsobjkey(1), true, "12.0.0.0/16",
    ...
    feeder2.init(k_vpc_key, k_subnet_key, "11.0.0.2/8",
                 ...
                 1, PDS_MAX_VNIC_IP, PDS_MAPPING_TYPE_L3,
                 PDS_MAX_TAGS_PER_MAPPING);
    workflow_u1_neg_1<local_mapping_feeder>(feeder1, feeder2);
