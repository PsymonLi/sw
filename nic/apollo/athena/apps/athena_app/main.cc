...
#include "nic/apollo/athena/agent/pds_agent_init.h"
...
/*
 * Host to Switch: Non TCP/UDP/ICMP Flow-miss
 */
uint8_t g_snd_pkt_no_l4_h2s[] = {
    0x00, 0x00, 0xF1, 0xD0, 0xD1, 0xD0, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x01, 0x81, 0x00, 0x00, 0x64,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x50, 0x00, 0x01,
    0x00, 0x00, 0x40, 0xFF, 0xB5, 0xAC, 0x02, 0x00,
    0x00, 0x01, 0xC0, 0x00, 0x02, 0x01, 0x03, 0xE8,
    0x27, 0x10, 0x00, 0x3C, 0x00, 0x00, 0x61, 0x62,
    0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A,
    0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72,
...
/*
 * Switch to Host: Non TCP/UDP/ICMP flow-miss
 */
uint8_t g_snd_pkt_no_l4_s2h[] = {
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x00, 0x06,
    0x07, 0x08, 0x09, 0x0A, 0x81, 0x00, 0x00, 0x01,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x74, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x11, 0x70, 0x70, 0x01, 0x02,
    0x03, 0x04, 0x04, 0x03, 0x02, 0x01, 0xE4, 0xE7,
    0x19, 0xEB, 0x00, 0x60, 0x00, 0x00, 0x54, 0x32,
    0x10, 0x00, 0x00, 0x3E, 0x81, 0x00, 0x45, 0x00,
    0x00, 0x50, 0x00, 0x01, 0x00, 0x00, 0x40, 0xFF,
    0xB5, 0xAC, 0xC0, 0x00, 0x02, 0x01, 0x02, 0x00,
    0x00, 0x01, 0x27, 0x10, 0x03, 0xE8, 0x00, 0x3C,
    0x00, 0x00, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66,
    0x67, 0x68, 0x69, 0x6A, 0x6C, 0x6B, 0x6D, 0x6E,
    0x6F, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76,
...
static uint8_t g_snd_pkt_l2_nat_s2h[] = {
 ...
 /*
  * Switch to Host TCP L2 flow: SYN Packet to be sent
  */
static uint8_t g_snd_pkt_l2_ipv4_tcp_s2h_s[] = {
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x00, 0x06,
    0x07, 0x08, 0x09, 0x0A, 0x81, 0x00, 0x00, 0x03,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x9E, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x11, 0x70, 0x46, 0x01, 0x02,
    ...
    0x17, 0xC1, 0x00, 0x8A, 0x00, 0x00, 0x04, 0x00,
    0x65, 0x58, 0x01, 0x23, 0x45, 0x00, 0x00, 0x00,
    0x21, 0x01, 0x00, 0x00, 0x07, 0xD5, 0x00, 0x00,
    0x22, 0x01, 0x00, 0x00, 0x07, 0xD4, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x01, 0x00, 0x00, 0xF1, 0xD0,
    0xD1, 0xD0, 0x08, 0x00, 0x45, 0x00, 0x00, 0x5C,
    0x00, 0x00, 0x00, 0x00, 0x40, 0x06, 0xB6, 0x9A,
    0xC0, 0x00, 0x02, 0x01, 0x02, 0x00, 0x00, 0x01,
...
/*
 * Host to Switch TCP L2 flow: SYN_ACK Packet to be sent
 */
static uint8_t g_snd_pkt_l2_ipv4_tcp_h2s_sa[] = {
    0x00, 0x00, 0xF1, 0xD0, 0xD1, 0xD0, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x01, 0x81, 0x00, 0x00, 0xCC,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x5C, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x06, 0xB6, 0x9A, 0x02, 0x00,
    0x00, 0x01, 0xC0, 0x00, 0x02, 0x01, 0x03, 0xE8,
    0x27, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
main (int argc, char **argv)
{
    ...
    */
    ...
    sleep(5);
    recv_packet();
    send_packet("h2s Non TCP/UDP/ICMP pkt:flow-miss", g_snd_pkt_no_l4_h2s, sizeof(g_snd_pkt_no_l4_h2s), g_h2s_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
    send_packet("s2h Non TCP/UDP/ICMP pkt:flow-miss", g_snd_pkt_no_l4_s2h, sizeof(g_snd_pkt_no_l4_s2h), g_s2h_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
    ...
    sleep(5);
    recv_packet();
    send_packet("L2 s2h TCP SYN pkt:flow-miss", g_snd_pkt_l2_ipv4_tcp_s2h_s, sizeof(g_snd_pkt_l2_ipv4_tcp_s2h_s), g_s2h_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
    send_packet("L2 h2s TCP SYN_ACK pkt:flow-miss", g_snd_pkt_l2_ipv4_tcp_h2s_sa, sizeof(g_snd_pkt_l2_ipv4_tcp_h2s_sa), g_h2s_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
#endif /* __x86_64__ */
...
bool
conntrack_dump(test_vparam_ref_t vparam)
{
    const char  *fname = vparam.expected_str().c_str();
    uint32_t    start_idx = 0;
    uint32_t    count = 0;
    ...
    return fte_ath::fte_dump_conntrack(fname, false,
                                       start_idx, count) == PDS_RET_OK;
}
