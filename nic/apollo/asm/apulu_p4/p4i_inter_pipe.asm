...
ingress_to_egress:
    ...
    */
    phvwr.e         p.{p4i_i2e_valid, \
                        ...
                        capri_p4_intrinsic_valid}, 0x401
...
ingress_to_rxdma:
    ...
    */
    phvwr           p.{p4i_i2e_valid, \
                        ...
                        p4plus_to_p4_valid, \
                        capri_txdma_intrinsic_valid, \
                        capri_p4_intrinsic_valid}, 0x741
...
ingress_recirc:
    ...
    */
    phvwr.e         p.{p4i_i2e_valid, \
                        ...
                        p4plus_to_p4_valid, \
                        capri_txdma_intrinsic_valid, \
                        capri_p4_intrinsic_valid}, 0x081
