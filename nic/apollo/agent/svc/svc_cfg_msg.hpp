...
typedef enum cfg_msg_e {
    ...
    CFG_MSG_DEVICE_GET,
    CFG_MSG_VPORT_CREATE,
    CFG_MSG_VPORT_UPDATE,
    CFG_MSG_VPORT_DELETE,
    CFG_MSG_VPORT_GET,
    CFG_MSG_COMMAND,
    CFG_MSG_IPSEC_SA_ENCRYPT_CREATE,
    CFG_MSG_IPSEC_SA_ENCRYPT_DELETE,
    CFG_MSG_IPSEC_SA_ENCRYPT_GET,
