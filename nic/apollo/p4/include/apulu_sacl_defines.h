...
#define SACL_P3_TABLE_NUM_ENTRIES         (1 << 16) // P1:P2 (2^10 * 2^10)
#define SACL_P3_TABLE_SIZE                1458944   // round64((1<<20)*(64/46))
...
#define SACL_P3_TABLE_OFFSET            (SACL_P2_TABLE_OFFSET +\
                                         SACL_P2_TABLE_SIZE)
#define SACL_DIP_TABLE_OFFSET           (SACL_P3_TABLE_OFFSET +\
                                         SACL_P3_TABLE_SIZE)
