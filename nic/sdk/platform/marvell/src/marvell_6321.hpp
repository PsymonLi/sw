...
#define MARVELL_STATS_OP_CLEAR_ALL      (1 << 12)
#define MARVELL_STATS_OP_CLEAR          (2 << 12)
#define MARVELL_STATS_OP_READ           (4 << 12)

#define MARVELL_STATS_OP_BUSY_CLR_ALL   (MARVELL_STATS_OP_BUSY | MARVELL_STATS_OP_CLEAR_ALL)
#define MARVELL_STATS_OP_BUSY_CLR       (MARVELL_STATS_OP_BUSY | MARVELL_STATS_OP_CLEAR)
