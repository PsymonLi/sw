...
#define ELBTRACE_MAX_ARG 3
#define ELBTRACE_MAX_MPU 4
...
typedef struct mputrace_global_state_s {
    ...
    mem_addr_t mputrace_base;
    mem_addr_t mputrace_end;
...
} elbtrace_global_state_t;

extern elbtrace_global_state_t g_state;
