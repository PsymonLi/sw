...
#ifndef __ELB_MX_COMMON_API_H__
#define __ELB_MX_COMMON_API_H__
...
void elb_mx_set_soft_reset(int chip_id, int inst_id, int port, int ch,
                           int value);
void elb_mx_set_clock_info(int chip_id, int inst_id, int value);
int elb_mx_set_ch_mode(int chip_id, int inst_id, int ch, int speed,
                       int num_lanes, int fec);
...
void elb_mx_pcs_lpbk_set(int chip_id, int inst_id, int ch, int num_lanes,
                          int value);
void elb_mx_set_auto_flush(int chip_id, int inst_id, int port,
                           int flush_timeout);
...
extern "C" void elb_mx_set_tx_autodrain(int chip_id, int inst_id, int ch,
                                        int value);
...
int elb_mx_slot_gen(int inst_id, int *port_vec, int *port_ch_map,
                    int *port_speed, int *slot_port, int *slot_ch);
void elb_mx_get_slot(int chip_id, int inst_id);
int elb_mx_set_slot(int chip_id, int inst_id, int *slot_port, int *slot_ch);
void elb_mx_slot_gen(int inst_id, int port_vec0, int port_ch_map0,
                     int port_speed0, int port_vec1, int port_ch_map1,
                     int port_speed1, int port_vec2, int port_ch_map2,
                     int port_speed2, int port_vec3, int port_ch_map3,
                     int port_speed3, int port_vec4, int port_ch_map4,
                     int port_speed4);
void elb_mx_set_slot(int chip_id, int inst_id, int slot_port0, int slot_ch0,
                     int slot_port1, int slot_ch1, int slot_port2,
                     int slot_ch2, int slot_port3, int slot_ch3, int slot_port4,
                     int slot_ch4, int slot_port5, int slot_ch5, int slot_port6,
                     int slot_ch6, int slot_port7, int slot_ch7);

void elb_mx_set_mtu_jabber(int chip_id , int inst_id, int ch, int max_value,
                           int jabber_value);
int elb_mx_set_pause(int chip_id, int inst_id, int port, int ch, int pri_vec,
                     int legacy, bool tx_pause_enable, bool rx_pause_enable);
int elb_mx_set_pause_src_addr(int chip_id, int inst_id, int ch,
                              uint8_t *mac_addr);
int elb_mx_set_pause_dest_addr(int chip_id, int inst_id, int ch,
                               uint8_t *mac_addr);
...
void elb_mx_set_txthresh(int chip_id, int inst_id, int ch, int txwrthresh,
                         int txrdthresh);
...
void elb_mx_set_vlan_check(int chip_id, int inst_id, int mac_ch, int num_tags,
                            uint32_t tag1, uint32_t tag2, uint32_t tag3);
...
void elb_mx_enable_false_linkup_detection(int chip_id , int inst_id, int ch,
                                          int value);
...
uint64_t elb_mx_read_stats(int chip_id, int inst_id, int ch, int index,
...
void elb_mx_get_mac_stat(int chip_id, int inst_id, int ch, int stat_type=0,
                         bool skip_zero=true, bool clear_on_read=false,
                         bool display=true);
void elb_mx_get_mac_stat_err(int chip_id, int inst_id, int ch,
                             bool skip_zero=true, bool clear_on_read=false,
                             bool display=true);
void elb_mx_get_mac_stat_pause(int chip_id, int inst_id, int ch,
                               bool skip_zero=true, bool clear_on_read=false,
                               bool display=true);

int elb_mx_get_mac_int(int chip_id, int inst_id, int ch,
                       bool clear_on_read=false, bool display=true);
...
int elb_mx_get_an_int(int chip_id, int inst_id, int ch,
                      bool clear_on_read=false, bool display=true);
...
int elb_mx_get_int_sd(int chip_id, int inst_id, bool clear_on_read=false,
                      bool display=true);
...
int elb_mx_get_int_mac(int chip_id, int inst_id, bool clear_on_read=false,
                       bool display=true);
...
int elb_mx_get_int_ecc(int chip_id, int inst_id, bool clear_on_read=false,
                       bool display=true);
...
int elb_mx_get_int_fixer(int chip_id, int inst_id, bool clear_on_read=false,
                         bool display=true);
...
int elb_mx_get_int_flush(int chip_id, int inst_id, bool clear_on_read=false,
                         bool display=true);
...
uint64_t elb_mx_an_get_rx_base_page(int chip_id, int inst_id, int ch,
                                    bool display=true);
void elb_mx_an_write_tx_page(int chip_id, int inst_id, int ch, int idx,
                             uint64_t page);
...
void elb_mx_an_set_breaklinktimer(int chip_id, int inst_id, int ch,
                                  uint32_t value);
void elb_mx_an_init(int chip_id, int inst_id, int ch, int user_cap=0,
                    int user_fec=0, int user_pause=0, int ignore_nonce=0,
                    uint32_t breaklinktimer=0);
