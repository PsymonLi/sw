...
const (
	...
	ErrCollectorUpdate                                   = Error("ErrCollectorUpdate")
	ErrCollectorDelete                                   = Error("ErrCollectorDelete")
	ErrCollectorAlreadyDeleted                           = Error("ErrCollectorAlreadyDeleted")
	ErrExportCreate                                      = Error("ErrExportCreate")
	ErrExportUpdate                                      = Error("ErrExportUpdate")
	ErrExportDelete                                      = Error("ErrExportDelete")
	...
	ErrEventsGet                                         = Error("ErrEventsGet")
	ErrEventsRecv                                        = Error("ErrEventsRecv")
	ErrEventsFwd                                         = Error("ErrEventsFwd")
