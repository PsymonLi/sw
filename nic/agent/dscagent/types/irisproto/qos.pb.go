...
// CoppClearStatsRequest is used to clear stats of a Copp
type CoppClearStatsRequest struct {
	// key_or_handle is Copp's unique identifier
	KeyOrHandle *CoppKeyHandle `protobuf:"bytes,1,opt,name=key_or_handle,json=keyOrHandle" json:"key_or_handle,omitempty" venice:key`
}

func (m *CoppClearStatsRequest) Reset()                    { *m = CoppClearStatsRequest{} }
func (m *CoppClearStatsRequest) String() string            { return proto.CompactTextString(m) }
func (*CoppClearStatsRequest) ProtoMessage()               {}
func (*CoppClearStatsRequest) Descriptor() ([]byte, []int) { return fileDescriptorQos, []int{64} }

func (m *CoppClearStatsRequest) GetKeyOrHandle() *CoppKeyHandle {
	if m != nil {
		return m.KeyOrHandle
	}
	return nil
...
type CoppClearStatsRequestMsg struct {
	Request []*CoppClearStatsRequest `protobuf:"bytes,1,rep,name=request" json:"request,omitempty"`
}

func (m *CoppClearStatsRequestMsg) Reset()                    { *m = CoppClearStatsRequestMsg{} }
func (m *CoppClearStatsRequestMsg) String() string            { return proto.CompactTextString(m) }
func (*CoppClearStatsRequestMsg) ProtoMessage()               {}
func (*CoppClearStatsRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptorQos, []int{65} }

func (m *CoppClearStatsRequestMsg) GetRequest() []*CoppClearStatsRequest {
	if m != nil {
		return m.Request
	}
	return nil
...
// Codegen forms the Request and Response messages using the package name "qos"
// This is to calm the autogenerator
type EmptyResponseMsg struct {
	Response []*Empty `protobuf:"bytes,1,rep,name=response" json:"response,omitempty"`
}

func (m *EmptyResponseMsg) Reset()                    { *m = EmptyResponseMsg{} }
func (m *EmptyResponseMsg) String() string            { return proto.CompactTextString(m) }
func (*EmptyResponseMsg) ProtoMessage()               {}
func (*EmptyResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptorQos, []int{66} }

func (m *EmptyResponseMsg) GetResponse() []*Empty {
	if m != nil {
		return m.Response
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CoppClearStatsRequest)(nil), "qos.CoppClearStatsRequest")
	proto.RegisterType((*CoppClearStatsRequestMsg)(nil), "qos.CoppClearStatsRequestMsg")
	proto.RegisterType((*EmptyResponseMsg)(nil), "qos.EmptyResponseMsg")
...
type QOSClient interface {
	...
	CoppClearStats(ctx context.Context, in *CoppClearStatsRequestMsg, opts ...grpc.CallOption) (*EmptyResponseMsg, error)
}
...
func (c *qOSClient) CoppClearStats(ctx context.Context, in *CoppClearStatsRequestMsg, opts ...grpc.CallOption) (*EmptyResponseMsg, error) {
	out := new(EmptyResponseMsg)
	err := grpc.Invoke(ctx, "/qos.QOS/CoppClearStats", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QOSServer interface {
	...
	CoppClearStats(context.Context, *CoppClearStatsRequestMsg) (*EmptyResponseMsg, error)
}
...
func _QOS_CoppClearStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CoppClearStatsRequestMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QOSServer).CoppClearStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qos.QOS/CoppClearStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QOSServer).CoppClearStats(ctx, req.(*CoppClearStatsRequestMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _QOS_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CoppClearStats",
			Handler:    _QOS_CoppClearStats_Handler,
		},
	},
...
func (m *CoppClearStatsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CoppClearStatsRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *CoppClearStatsRequestMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CoppClearStatsRequestMsg) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *EmptyResponseMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EmptyResponseMsg) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *CoppClearStatsRequest) Size() (n int) {
	var l int
	_ = l
	if m.KeyOrHandle != nil {
		l = m.KeyOrHandle.Size()
...
func (m *CoppClearStatsRequestMsg) Size() (n int) {
	var l int
	_ = l
	if len(m.Request) > 0 {
		for _, e := range m.Request {
...
func (m *EmptyResponseMsg) Size() (n int) {
	var l int
	_ = l
	if len(m.Response) > 0 {
		for _, e := range m.Response {
...
func (m *CoppClearStatsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CoppClearStatsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CoppClearStatsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CoppClearStatsRequestMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CoppClearStatsRequestMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CoppClearStatsRequestMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Request = append(m.Request, &CoppClearStatsRequest{})
			if err := m.Request[len(m.Request)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *EmptyResponseMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EmptyResponseMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EmptyResponseMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorQos = []byte{
	...
	,
}
