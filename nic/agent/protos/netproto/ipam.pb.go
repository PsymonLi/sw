...
type IPAMPolicyStatus struct {
	// IPAMPolicy IDs in the datapath
	IPAMPolicyIDs []string `protobuf:"bytes,1,rep,name=IPAMPolicyIDs" json:"ipam-policy-ids,omitempty"`
}
...
func (m *IPAMPolicyStatus) GetIPAMPolicyIDs() []string {
	if m != nil {
		return m.IPAMPolicyIDs
	}
	return nil
}
...
func (m *IPAMPolicyStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.IPAMPolicyIDs) > 0 {
		for _, s := range m.IPAMPolicyIDs {
			dAtA[i] = 0xa
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *IPAMPolicyStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IPAMPolicyIDs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IPAMPolicyIDs = append(m.IPAMPolicyIDs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipIpam(dAtA[iNdEx:])
...
var fileDescriptorIpam = []byte{
	...
	,
}
