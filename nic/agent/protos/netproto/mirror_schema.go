...
var typesMapMirror = map[string]*api.Struct{
	...
	"netproto.InterfaceMirrorSession": &api.Struct{
		...
		CLITags: map[string]api.CLIInfo{
			...
			"mirror-session-ids": api.CLIInfo{Path: "Status.MirrorSessionIDs", Skip: false, Insert: "", Help: ""},
	...
	"netproto.InterfaceMirrorSessionStatus": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"MirrorSessionIDs": api.Field{Name: "MirrorSessionIDs", CLITag: api.CLIInfo{ID: "mirror-session-ids", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "mirror-session-ids", Pointer: false, Slice: true, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_UINT64"},
		},
	},
