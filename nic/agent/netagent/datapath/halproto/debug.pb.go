...
func (Command) EnumDescriptor() ([]byte, []int) { return fileDescriptorDebug, []int{7} }
...
type ClockSpec struct {
	HardwareTicks        uint64 `protobuf:"varint,1,opt,name=hardware_ticks,json=hardwareTicks,proto3" json:"hardware_ticks,omitempty"`
	SoftwareMilliseconds uint64 `protobuf:"varint,2,opt,name=software_milliseconds,json=softwareMilliseconds,proto3" json:"software_milliseconds,omitempty"`
	SoftwareNanoseconds  uint64 `protobuf:"varint,3,opt,name=software_nanoseconds,json=softwareNanoseconds,proto3" json:"software_nanoseconds,omitempty"`
}
...
func (m *ClockSpec) GetHardwareTicks() uint64 {
	if m != nil {
		return m.HardwareTicks
	}
	return 0
}

func (m *ClockSpec) GetSoftwareMilliseconds() uint64 {
	if m != nil {
		return m.SoftwareMilliseconds
	}
	return 0
}

func (m *ClockSpec) GetSoftwareNanoseconds() uint64 {
	if m != nil {
		return m.SoftwareNanoseconds
	}
	return 0
}
...
type SessionCtrlResponse struct {
	ApiStatus  ApiStatus `protobuf:"varint,1,opt,name=api_status,json=apiStatus,proto3,enum=types.ApiStatus" json:"api_status,omitempty" venice:api_status`
	MaxSession uint64    `protobuf:"varint,2,opt,name=max_session,json=maxSession,proto3" json:"max_session,omitempty"`
}

func (m *SessionCtrlResponse) Reset()                    { *m = SessionCtrlResponse{} }
func (m *SessionCtrlResponse) String() string            { return proto.CompactTextString(m) }
func (*SessionCtrlResponse) ProtoMessage()               {}
func (*SessionCtrlResponse) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{115} }

func (m *SessionCtrlResponse) GetApiStatus() ApiStatus {
	if m != nil {
		return m.ApiStatus
	}
	return ApiStatus_API_STATUS_OK
...
func (m *SessionCtrlResponse) GetMaxSession() uint64 {
	if m != nil {
		return m.MaxSession
	}
	return 0
...
type SessionCtrlResponseMsg struct {
	Response []*SessionCtrlResponse `protobuf:"bytes,1,rep,name=response" json:"response,omitempty"`
}

func (m *SessionCtrlResponseMsg) Reset()                    { *m = SessionCtrlResponseMsg{} }
func (m *SessionCtrlResponseMsg) String() string            { return proto.CompactTextString(m) }
func (*SessionCtrlResponseMsg) ProtoMessage()               {}
func (*SessionCtrlResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{116} }

func (m *SessionCtrlResponseMsg) GetResponse() []*SessionCtrlResponse {
	if m != nil {
		return m.Response
	}
	return nil
...
func (*OifListGetRequest) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{117} }
...
func (*OifListGetRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{118} }
...
func (*OifListGetResponse) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{119} }
...
func (*OifListGetResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{120} }
...
func (*CommandCtxt) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{121} }
...
func (*CommandResponse) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{122} }
...
func init() {
	...
	proto.RegisterType((*SessionCtrlResponse)(nil), "debug.SessionCtrlResponse")
	proto.RegisterType((*SessionCtrlResponseMsg)(nil), "debug.SessionCtrlResponseMsg")
...
type DebugClient interface {
	...
	SessionCtrlGet(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SessionCtrlResponseMsg, error)
...
func (c *debugClient) SessionCtrlGet(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SessionCtrlResponseMsg, error) {
	out := new(SessionCtrlResponseMsg)
	err := grpc.Invoke(ctx, "/debug.Debug/SessionCtrlGet", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DebugServer interface {
	...
	SessionCtrlGet(context.Context, *Empty) (*SessionCtrlResponseMsg, error)
...
func _Debug_SessionCtrlGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServer).SessionCtrlGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/debug.Debug/SessionCtrlGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).SessionCtrlGet(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Debug_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SessionCtrlGet",
			Handler:    _Debug_SessionCtrlGet_Handler,
		},
		{
...
func (m *ClockSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.HardwareTicks != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintDebug(dAtA, i, uint64(m.HardwareTicks))
	}
	if m.SoftwareMilliseconds != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintDebug(dAtA, i, uint64(m.SoftwareMilliseconds))
	}
	if m.SoftwareNanoseconds != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintDebug(dAtA, i, uint64(m.SoftwareNanoseconds))
	}
	return i, nil
}
...
func (m *SessionCtrlResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SessionCtrlResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SessionCtrlResponseMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SessionCtrlResponseMsg) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ClockSpec) Size() (n int) {
	...
	_ = l
	if m.HardwareTicks != 0 {
		n += 1 + sovDebug(uint64(m.HardwareTicks))
	}
	if m.SoftwareMilliseconds != 0 {
		n += 1 + sovDebug(uint64(m.SoftwareMilliseconds))
	}
	if m.SoftwareNanoseconds != 0 {
		n += 1 + sovDebug(uint64(m.SoftwareNanoseconds))
	}
	return n
}
...
func (m *SessionCtrlResponse) Size() (n int) {
	var l int
	_ = l
	if m.ApiStatus != 0 {
		n += 1 + sovDebug(uint64(m.ApiStatus))
...
func (m *SessionCtrlResponseMsg) Size() (n int) {
	var l int
	_ = l
	if len(m.Response) > 0 {
		for _, e := range m.Response {
...
func (m *ClockSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HardwareTicks", wireType)
			}
			m.HardwareTicks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HardwareTicks |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SoftwareMilliseconds", wireType)
			}
			m.SoftwareMilliseconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowDebug
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SoftwareMilliseconds |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SoftwareNanoseconds", wireType)
			}
			m.SoftwareNanoseconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowDebug
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SoftwareNanoseconds |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *SessionCtrlResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SessionCtrlResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SessionCtrlResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *SessionCtrlResponseMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SessionCtrlResponseMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SessionCtrlResponseMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Response = append(m.Response, &SessionCtrlResponse{})
			if err := m.Response[len(m.Response)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
var fileDescriptorDebug = []byte{
	...
	,
}
