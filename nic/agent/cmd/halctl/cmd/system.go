...
func sessionSummaryStatsShow(stats *halproto.Stats) {
	...
	fmt.Printf("%25s%25s\n", "Session Type", "Count")
	fmt.Println(hdrLine)
	fmt.Printf("%25s%25d\n", "Total Active", sessstats.GetTotalActive())
	fmt.Printf("%25s%25d\n", "L2", sessstats.GetNumL2())
	fmt.Printf("%25s%25d\n", "TCP", sessstats.GetNumTcp())
	fmt.Printf("%25s%25d\n", "UDP", sessstats.GetNumUdp())
	fmt.Printf("%25s%25d\n", "ICMP", sessstats.GetNumIcmp())
	fmt.Printf("%25s%25d\n", "Security Policy DROP", sessstats.GetNumSecurityPolicyDrops())
	fmt.Printf("%25s%25d\n", "AGED", sessstats.GetNumAged())
	fmt.Printf("%25s%25d\n", "TCP connection timeouts", sessstats.GetNumConnectionTimeout())
	fmt.Printf("%25s%25d\n", "TCP Resets on SFW Reject", sessstats.GetNumTcpResetSent())
	fmt.Printf("%25s%25d\n", "ICMP Errors on SFW Reject", sessstats.GetNumIcmpErrorSent())
	fmt.Printf("%25s%25d\n", "Session create failures", sessstats.GetNumCreateErrors())
	fmt.Printf("%25s%25d\n", "TCP Half-Open", sessstats.GetNumTcpHalfOpen())
	fmt.Printf("%25s%25d\n", "Other Active", sessstats.GetNumOtherActive())
	fmt.Printf("%25s%25d\n", "TCP Limit Drops", sessstats.GetNumTcpLimitDrops())
	fmt.Printf("%25s%25d\n", "UDP Limit Drops", sessstats.GetNumUdpLimitDrops())
	fmt.Printf("%25s%25d\n", "ICMP Limit Drops", sessstats.GetNumIcmpLimitDrops())
	fmt.Printf("%25s%25d\n", "Other Limit Drops", sessstats.GetNumOtherLimitDrops())
	fmt.Printf("%25s%25d\n", "DSC Limit Drops", sessstats.GetNumDscLimitDrops())
}
