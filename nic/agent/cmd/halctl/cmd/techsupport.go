...
func tsShowCmdHandler(cmd *cobra.Command, args []string) {
	...
	fmt.Printf("\nSystem BW Statistics\n\n")
	systemBwStatsShowCmdHandler(nil, nil)
	fmt.Printf("\nNCSI Vlan\n\n")
	ncsiVlanShowCmdHandler(nil, nil)
	fmt.Printf("\nNCSI Mac\n\n")
	ncsiMacShowCmdHandler(nil, nil)
	fmt.Printf("\nNCSI Bcast\n\n")
	ncsiBcastShowCmdHandler(nil, nil)
	fmt.Printf("\nNCSI Mcast\n\n")
	ncsiMcastShowCmdHandler(nil, nil)
	fmt.Printf("\nNCSI Channel\n\n")
	ncsiChannelShowCmdHandler(nil, nil)
