...
jobd/athena_app/policy_sim_gtests: ${JOBD_PREREQS}
	${NICDIR}/run.py ${COVERAGE_OPTS} --athena_app --disable_hugepages --athena_app_mock_mode --athena_app_runargs '-m gtest -j /sw/nic/conf/athena/policy_gtest_8k.json'
	${NICDIR}/run.py ${COVERAGE_OPTS} --athena_app --disable_hugepages --athena_app_mock_mode --athena_app_runargs '-m gtest -j /sw/nic/conf/athena/32vnic_scale.json'
	#${NICDIR}/run.py ${COVERAGE_OPTS} --athena_app --disable_hugepages --athena_app_mock_mode --athena_app_runargs '-m gtest -j /sw/nic/conf/athena/64vnic_scale.json'
	${NICDIR}/run.py ${COVERAGE_OPTS} --athena_app --disable_hugepages --athena_app_mock_mode --athena_app_runargs '-m gtest -j /sw/nic/conf/athena/128vnic_scale.json'
	${NICDIR}/run.py ${COVERAGE_OPTS} --athena_app --disable_hugepages --athena_app_mock_mode --athena_app_runargs '-m gtest -j /sw/nic/conf/athena/256vnic_scale.json'
...
jobd/dol/apulu/rfc_ingress: ${JOBD_PREREQS}
	...
	${NICDIR}/apollo/tools/rundol.sh --pipeline apulu --feature rfc --topo rfc_dual_policy --sub ipv4_ingress_dual_policy
...
jobd/dol/apulu/rfc_egress: ${JOBD_PREREQS}
	...
	${NICDIR}/apollo/tools/rundol.sh --pipeline apulu --feature rfc --topo rfc_dual_policy --sub ipv4_egress_dual_policy
...
jobd/dol/apulu/rfc_tags: ${JOBD_PREREQS}
	...
	${NICDIR}/apollo/tools/rundol.sh --pipeline apulu --feature rfc --topo rfc_tags_any --sub ipv4_ingress_tag_any,ipv4_egress_tag_any
	${NICDIR}/apollo/tools/rundol.sh --pipeline apulu --feature rfc --topo rfc_tags_pfx --sub ipv4_egress_tag_pfx,ipv4_ingress_tag_pfx
	${NICDIR}/apollo/tools/rundol.sh --pipeline apulu --feature rfc --topo rfc_tags_only --sub ipv4_tag_only_egress,ipv4_tag_only_ingress
