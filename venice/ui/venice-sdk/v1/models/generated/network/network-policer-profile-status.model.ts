...
export interface INetworkPolicerProfileStatus {
    'propagation-status'?: ISecurityPropagationStatus;
    '_ui'?: any;
}


export class NetworkPolicerProfileStatus extends BaseModel implements INetworkPolicerProfileStatus {
    /** Field for holding arbitrary ui state */
    '_ui': any = {};
    /** The status of the configuration propagation to the Naples. */
    'propagation-status': SecurityPropagationStatus = null;
    public static propInfo: { [prop in keyof INetworkPolicerProfileStatus]: PropInfoItem } = {
        'propagation-status': {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return NetworkPolicerProfileStatus.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return NetworkPolicerProfileStatus.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (NetworkPolicerProfileStatus.propInfo[prop] != null &&
                        NetworkPolicerProfileStatus.propInfo[prop].default != null);
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'propagation-status': CustomFormGroup(this['propagation-status'].$formGroup, NetworkPolicerProfileStatus.propInfo['propagation-status'].required),
            });
