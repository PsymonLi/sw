    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                ...
                'vlan-id': CustomFormControl(new FormControl(this['vlan-id'], [required, minValueValidator(0), maxValueValidator(4095), ]), NetworkNetworkSpec.propInfo['vlan-id']),
                'vxlan-vni': CustomFormControl(new FormControl(this['vxlan-vni'], [required, minValueValidator(0), maxValueValidator(16777215), ]), NetworkNetworkSpec.propInfo['vxlan-vni']),
